...
T = TypeVar("T", bound="CBOClusterRequest")


@_attrs_define
class CBOClusterRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cbo_cluster_request.additional_properties = d
        return cbo_cluster_request
