...
T = TypeVar("T", bound="FilterPercentageRequest")


@_attrs_define
class FilterPercentageRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        filter_percentage_request.additional_properties = d
        return filter_percentage_request
