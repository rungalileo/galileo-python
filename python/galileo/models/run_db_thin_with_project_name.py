...
T = TypeVar("T", bound="RunDBThinWithProjectName")


@_attrs_define
class RunDBThinWithProjectName:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        run_db_thin_with_project_name = cls(
            created_at=created_at,
            created_by=created_by,
            creator=creator,
            id=id,
        ...
        run_db_thin_with_project_name.additional_properties = d
        return run_db_thin_with_project_name
