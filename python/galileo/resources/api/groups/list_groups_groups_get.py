...
def _get_kwargs(*, starting_token: Union[Unset, int] = 0, limit: Union[Unset, int] = 100) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {"method": "get", "url": "/groups", "params": params}
...
) -> Optional[Union[HTTPValidationError, ListGroupsResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, ListGroupsResponse]]:
    return Response(
...
def sync(
    *, client: AuthenticatedClient, starting_token: Union[Unset, int] = 0, limit: Union[Unset, int] = 100
    ...
    Returns:
        Union[HTTPValidationError, ListGroupsResponse]
    """
