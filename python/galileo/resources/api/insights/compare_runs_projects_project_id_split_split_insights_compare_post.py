...
from ...models.compare_runs_response import CompareRunsResponse
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CompareRunsResponse.from_dict(response.json())
...
def sync_detailed(
    ...
    """Compare Runs
     ...
     Gets overall statistics for multiple runs as well as slice statistics.
