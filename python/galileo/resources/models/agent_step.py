...
class AgentStep:
    """
    Attributes:
        input_ (Union['AgentStepInputType3', 'Document', 'Message', list['AgentStepInputType7Item'],
            list['AgentStepInputType8Item'], list['Document'], list['Message'], list[str], str]): Input to the step.
        ...
        metadata (Union[Unset, AgentStepMetadata]): Metadata associated with this step.
        name (Union[Unset, str]): Name of the step. Default: ''.
        output (Union['AgentStepOutputType3', 'Document', 'Message', Unset, list['AgentStepOutputType7Item'],
            list['AgentStepOutputType8Item'], list['Document'], list['Message'], list[str], str]): Output of the step.
            Default: ''.
        ...
        type_ (Union[Literal['agent'], Unset]): Type of the step. By default, it is set to agent. Default: 'agent'.
    """
    ...
    metadata: Union[Unset, "AgentStepMetadata"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, AgentStepMetadata]
