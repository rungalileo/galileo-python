...
class CurrentUserDB:
    ...
    Attributes:
        ...
        generic_permissions (Union[Unset, list['GenericPermission']]):
    ...
    generic_permissions: Union[Unset, list["GenericPermission"]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        generic_permissions: Union[Unset, list[dict[str, Any]]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for generic_permissions_item_data in _generic_permissions or []:
