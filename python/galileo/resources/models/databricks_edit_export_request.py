...
if TYPE_CHECKING:
    from ..models.databricks_edit_export_request_col_mapping_type_0 import DatabricksEditExportRequestColMappingType0
    from ..models.edit_override import EditOverride
    from ..models.filter_params import FilterParams


T = TypeVar("T", bound="DatabricksEditExportRequest")


@_attrs_define
class DatabricksEditExportRequest:
    """
    Attributes:
        database_name (str):
        edit_ids (list[str]):
        ...
        col_mapping (Union['DatabricksEditExportRequestColMappingType0', None, Unset]):  Default: None.
    ...
    col_mapping: Union["DatabricksEditExportRequestColMappingType0", None, Unset] = None
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.databricks_edit_export_request_col_mapping_type_0 import (
        ...
        if isinstance(self.col_mapping, Unset):
            col_mapping = UNSET
        elif isinstance(self.col_mapping, DatabricksEditExportRequestColMappingType0):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_col_mapping(data: object) -> Union["DatabricksEditExportRequestColMappingType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                col_mapping_type_0 = DatabricksEditExportRequestColMappingType0.from_dict(data)

                return col_mapping_type_0
            except:  # noqa: E722
                pass
            return cast(Union["DatabricksEditExportRequestColMappingType0", None, Unset], data)
        ...
        databricks_edit_export_request = cls(
        ...
        databricks_edit_export_request.additional_properties = d
        return databricks_edit_export_request
