...
if TYPE_CHECKING:
    from ..models.databricks_edit_export_response_col_mapping_type_0 import DatabricksEditExportResponseColMappingType0
    from ..models.edit_override import EditOverride
    from ..models.filter_params import FilterParams


T = TypeVar("T", bound="DatabricksEditExportResponse")


@_attrs_define
class DatabricksEditExportResponse:
    """
    Attributes:
        database_name (str):
        edit_ids (list[str]):
        ...
        col_mapping (Union['DatabricksEditExportResponseColMappingType0', None, Unset]):  Default: None.
    ...
    col_mapping: Union["DatabricksEditExportResponseColMappingType0", None, Unset] = None
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.databricks_edit_export_response_col_mapping_type_0 import (
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_col_mapping(data: object) -> Union["DatabricksEditExportResponseColMappingType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                col_mapping_type_0 = DatabricksEditExportResponseColMappingType0.from_dict(data)
        ...
        return databricks_edit_export_response
