...
T = TypeVar("T", bound="EditCreateRequestEditSpansType0")


@_attrs_define
class EditCreateRequestEditSpansType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        edit_create_request_edit_spans_type_0 = cls()
        ...
        edit_create_request_edit_spans_type_0.additional_properties = additional_properties
        return edit_create_request_edit_spans_type_0
