...
T = TypeVar("T", bound="EditCreateResponseEditSpansType0")


@_attrs_define
class EditCreateResponseEditSpansType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        edit_create_response_edit_spans_type_0 = cls()
        ...
        edit_create_response_edit_spans_type_0.additional_properties = additional_properties
        return edit_create_response_edit_spans_type_0
