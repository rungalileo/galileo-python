...
T = TypeVar("T", bound="EditOverrideEditSpansType0")


@_attrs_define
class EditOverrideEditSpansType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        edit_override_edit_spans_type_0 = cls()
        ...
        edit_override_edit_spans_type_0.additional_properties = additional_properties
        return edit_override_edit_spans_type_0
