...
if TYPE_CHECKING:
    ...
    from ..models.retriever_span_with_metrics_input_type_3 import RetrieverSpanWithMetricsInputType3
    from ..models.retriever_span_with_metrics_input_type_7_item import RetrieverSpanWithMetricsInputType7Item
    from ..models.retriever_span_with_metrics_input_type_8_item import RetrieverSpanWithMetricsInputType8Item
    from ..models.retriever_span_with_metrics_metadata import RetrieverSpanWithMetricsMetadata
    from ..models.retriever_span_with_metrics_metrics import RetrieverSpanWithMetricsMetrics
    from ..models.retriever_span_with_metrics_output_type_3 import RetrieverSpanWithMetricsOutputType3
    from ..models.retriever_span_with_metrics_output_type_7_item import RetrieverSpanWithMetricsOutputType7Item
    from ..models.retriever_span_with_metrics_output_type_8_item import RetrieverSpanWithMetricsOutputType8Item
    from ..models.step_with_child_spans import StepWithChildSpans


T = TypeVar("T", bound="RetrieverSpanWithMetrics")


@_attrs_define
class RetrieverSpanWithMetrics:
    """
    Attributes:
        input_ (Union['Document', 'Message', 'RetrieverSpanWithMetricsInputType3', list['Document'], list['Message'],
            list['RetrieverSpanWithMetricsInputType7Item'], list['RetrieverSpanWithMetricsInputType8Item'], list[str],
        ...
        metadata (Union[Unset, RetrieverSpanWithMetricsMetadata]): Metadata associated with this step.
        metrics (Union[Unset, RetrieverSpanWithMetricsMetrics]):
        name (Union[Unset, str]): Name of the step. Default: ''.
        output (Union['Document', 'Message', 'RetrieverSpanWithMetricsOutputType3', Unset, list['Document'],
            list['Message'], list['RetrieverSpanWithMetricsOutputType7Item'],
            list['RetrieverSpanWithMetricsOutputType8Item'], list[str], str]): Output of the step. Default: ''.
    ...
    input_: Union[
        ...
        list["Document"],
        list["Message"],
        list["RetrieverSpanWithMetricsInputType7Item"],
        list["RetrieverSpanWithMetricsInputType8Item"],
        list[str],
        str,
    ]
    step_id: str
    ...
    metadata: Union[Unset, "RetrieverSpanWithMetricsMetadata"] = UNSET
    metrics: Union[Unset, "RetrieverSpanWithMetricsMetrics"] = UNSET
    ...
    output: Union[
        ...
        list["Document"],
        list["Message"],
        list["RetrieverSpanWithMetricsOutputType7Item"],
        list["RetrieverSpanWithMetricsOutputType8Item"],
        list[str],
        str,
    ] = ""
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.input_, Document):
            ...
            input_ = self.input_.to_dict()
        elif isinstance(self.input_, RetrieverSpanWithMetricsInputType3):
            input_ = self.input_.to_dict()
        ...
        if isinstance(self.output, Unset):
            ...
            output = self.output.to_dict()
        elif isinstance(self.output, RetrieverSpanWithMetricsOutputType3):
            output = self.output.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_input_(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                input_type_3 = RetrieverSpanWithMetricsInputType3.from_dict(data)
            ...
            try:
                ...
                for input_type_7_item_data in _input_type_7:
                    input_type_7_item = RetrieverSpanWithMetricsInputType7Item.from_dict(input_type_7_item_data)
            ...
            try:
                ...
                for input_type_8_item_data in _input_type_8:
                    input_type_8_item = RetrieverSpanWithMetricsInputType8Item.from_dict(input_type_8_item_data)
        ...
        metadata: Union[Unset, RetrieverSpanWithMetricsMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = RetrieverSpanWithMetricsMetadata.from_dict(_metadata)
        ...
        if isinstance(_metrics, Unset):
            ...
            metrics = RetrieverSpanWithMetricsMetrics.from_dict(_metrics)
        ...
        def _parse_output(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                output_type_3 = RetrieverSpanWithMetricsOutputType3.from_dict(data)
            ...
            try:
                ...
                for output_type_7_item_data in _output_type_7:
                    output_type_7_item = RetrieverSpanWithMetricsOutputType7Item.from_dict(output_type_7_item_data)
            ...
            try:
                ...
                for output_type_8_item_data in _output_type_8:
                    output_type_8_item = RetrieverSpanWithMetricsOutputType8Item.from_dict(output_type_8_item_data)
        ...
        retriever_span_with_metrics = cls(
            input_=input_,
            step_id=step_id,
            trace_id=trace_id,
        ...
        retriever_span_with_metrics.additional_properties = d
        return retriever_span_with_metrics
