...
T = TypeVar("T", bound="SliceUpdateResponse")


@_attrs_define
class SliceUpdateResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        slice_update_response.additional_properties = d
        return slice_update_response
