...
if TYPE_CHECKING:
    ...
    from ..models.step_with_child_spans_input_type_3 import StepWithChildSpansInputType3
    from ..models.step_with_child_spans_input_type_7_item import StepWithChildSpansInputType7Item
    from ..models.step_with_child_spans_input_type_8_item import StepWithChildSpansInputType8Item
    from ..models.step_with_child_spans_metadata import StepWithChildSpansMetadata
    from ..models.step_with_child_spans_output_type_3 import StepWithChildSpansOutputType3
    from ..models.step_with_child_spans_output_type_7_item import StepWithChildSpansOutputType7Item
    from ..models.step_with_child_spans_output_type_8_item import StepWithChildSpansOutputType8Item
    from ..models.tool_span import ToolSpan
    from ..models.workflow_span import WorkflowSpan


T = TypeVar("T", bound="StepWithChildSpans")
...
class StepWithChildSpans:
    """
    Attributes:
        input_ (Union['Document', 'Message', 'StepWithChildSpansInputType3', list['Document'], list['Message'],
            list['StepWithChildSpansInputType7Item'], list['StepWithChildSpansInputType8Item'], list[str], str]): Input to
            the step.
        ...
        metadata (Union[Unset, StepWithChildSpansMetadata]): Metadata associated with this step.
        name (Union[Unset, str]): Name of the step. Default: ''.
        output (Union['Document', 'Message', 'StepWithChildSpansOutputType3', Unset, list['Document'], list['Message'],
            list['StepWithChildSpansOutputType7Item'], list['StepWithChildSpansOutputType8Item'], list[str], str]): Output
            of the step. Default: ''.
    ...
    input_: Union[
        ...
        list["Document"],
        list["Message"],
        list["StepWithChildSpansInputType7Item"],
        list["StepWithChildSpansInputType8Item"],
        list[str],
        str,
    ]
    ...
    metadata: Union[Unset, "StepWithChildSpansMetadata"] = UNSET
    ...
    output: Union[
        ...
        list["Document"],
        list["Message"],
        list["StepWithChildSpansOutputType7Item"],
        list["StepWithChildSpansOutputType8Item"],
        list[str],
        str,
    ] = ""
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.input_, Document):
            ...
            input_ = self.input_.to_dict()
        elif isinstance(self.input_, StepWithChildSpansInputType3):
            input_ = self.input_.to_dict()
        ...
        if isinstance(self.output, Unset):
            ...
            output = self.output.to_dict()
        elif isinstance(self.output, StepWithChildSpansOutputType3):
            output = self.output.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_input_(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                input_type_3 = StepWithChildSpansInputType3.from_dict(data)
            ...
            try:
                ...
                for input_type_7_item_data in _input_type_7:
                    input_type_7_item = StepWithChildSpansInputType7Item.from_dict(input_type_7_item_data)
            ...
            try:
                ...
                for input_type_8_item_data in _input_type_8:
                    input_type_8_item = StepWithChildSpansInputType8Item.from_dict(input_type_8_item_data)
        ...
        metadata: Union[Unset, StepWithChildSpansMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = StepWithChildSpansMetadata.from_dict(_metadata)
        ...
        def _parse_output(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                output_type_3 = StepWithChildSpansOutputType3.from_dict(data)
            ...
            try:
                ...
                for output_type_7_item_data in _output_type_7:
                    output_type_7_item = StepWithChildSpansOutputType7Item.from_dict(output_type_7_item_data)
            ...
            try:
                ...
                for output_type_8_item_data in _output_type_8:
                    output_type_8_item = StepWithChildSpansOutputType8Item.from_dict(output_type_8_item_data)
        ...
        step_with_child_spans.additional_properties = d
        return step_with_child_spans
