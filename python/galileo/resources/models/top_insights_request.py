...
T = TypeVar("T", bound="TopInsightsRequest")


@_attrs_define
class TopInsightsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        top_insights_request.additional_properties = d
        return top_insights_request
