...
if TYPE_CHECKING:
    ...
    from ..models.trace_with_metrics_input_type_3 import TraceWithMetricsInputType3
    from ..models.trace_with_metrics_input_type_7_item import TraceWithMetricsInputType7Item
    from ..models.trace_with_metrics_input_type_8_item import TraceWithMetricsInputType8Item
    from ..models.trace_with_metrics_metadata import TraceWithMetricsMetadata
    from ..models.trace_with_metrics_metrics import TraceWithMetricsMetrics
    from ..models.trace_with_metrics_output_type_3 import TraceWithMetricsOutputType3
    from ..models.trace_with_metrics_output_type_7_item import TraceWithMetricsOutputType7Item
    from ..models.trace_with_metrics_output_type_8_item import TraceWithMetricsOutputType8Item
    from ..models.workflow_span_with_metrics import WorkflowSpanWithMetrics


T = TypeVar("T", bound="TraceWithMetrics")


@_attrs_define
class TraceWithMetrics:
    """
    Attributes:
        input_ (Union['Document', 'Message', 'TraceWithMetricsInputType3', list['Document'], list['Message'],
            list['TraceWithMetricsInputType7Item'], list['TraceWithMetricsInputType8Item'], list[str], str]): Input to the
            step.
        step_id (str):
        trace_id (str):
        ...
        metadata (Union[Unset, TraceWithMetricsMetadata]): Metadata associated with this step.
        metrics (Union[Unset, TraceWithMetricsMetrics]):
        name (Union[Unset, str]): Name of the step. Default: ''.
        output (Union['Document', 'Message', 'TraceWithMetricsOutputType3', Unset, list['Document'], list['Message'],
            list['TraceWithMetricsOutputType7Item'], list['TraceWithMetricsOutputType8Item'], list[str], str]): Output of
            the step. Default: ''.
    ...
    input_: Union[
        ...
        list["Document"],
        list["Message"],
        list["TraceWithMetricsInputType7Item"],
        list["TraceWithMetricsInputType8Item"],
        list[str],
        str,
    ]
    step_id: str
    ...
    metadata: Union[Unset, "TraceWithMetricsMetadata"] = UNSET
    metrics: Union[Unset, "TraceWithMetricsMetrics"] = UNSET
    ...
    output: Union[
        ...
        list["Document"],
        list["Message"],
        list["TraceWithMetricsOutputType7Item"],
        list["TraceWithMetricsOutputType8Item"],
        list[str],
        str,
    ] = ""
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.input_, Document):
            ...
            input_ = self.input_.to_dict()
        elif isinstance(self.input_, TraceWithMetricsInputType3):
            input_ = self.input_.to_dict()
        ...
        if isinstance(self.output, Unset):
            ...
            output = self.output.to_dict()
        elif isinstance(self.output, TraceWithMetricsOutputType3):
            output = self.output.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_input_(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                input_type_3 = TraceWithMetricsInputType3.from_dict(data)
            ...
            try:
                ...
                for input_type_7_item_data in _input_type_7:
                    input_type_7_item = TraceWithMetricsInputType7Item.from_dict(input_type_7_item_data)
            ...
            try:
                ...
                for input_type_8_item_data in _input_type_8:
                    input_type_8_item = TraceWithMetricsInputType8Item.from_dict(input_type_8_item_data)
        ...
        metadata: Union[Unset, TraceWithMetricsMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = TraceWithMetricsMetadata.from_dict(_metadata)
        ...
        if isinstance(_metrics, Unset):
            ...
            metrics = TraceWithMetricsMetrics.from_dict(_metrics)
        ...
        def _parse_output(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                output_type_3 = TraceWithMetricsOutputType3.from_dict(data)
            ...
            try:
                ...
                for output_type_7_item_data in _output_type_7:
                    output_type_7_item = TraceWithMetricsOutputType7Item.from_dict(output_type_7_item_data)
            ...
            try:
                ...
                for output_type_8_item_data in _output_type_8:
                    output_type_8_item = TraceWithMetricsOutputType8Item.from_dict(output_type_8_item_data)
        ...
        trace_with_metrics.additional_properties = d
        return trace_with_metrics
