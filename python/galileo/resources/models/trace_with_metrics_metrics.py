...
T = TypeVar("T", bound="TraceWithMetricsMetrics")


@_attrs_define
class TraceWithMetricsMetrics:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        trace_with_metrics_metrics = cls()
        ...
        trace_with_metrics_metrics.additional_properties = additional_properties
        return trace_with_metrics_metrics
