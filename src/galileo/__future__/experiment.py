...
class Experiment(StateManagementMixin):
    ...
    **Dataset Requirements:**
    ...
    metrics: builtins.list[GalileoMetrics | GalileoMetricNames | Metric | LocalMetricConfig | str] | None
    ...
    def __init__(
        ...
        *,
        ...
        metrics: builtins.list[GalileoMetrics | GalileoMetricNames | Metric | LocalMetricConfig | str] | None = None,
