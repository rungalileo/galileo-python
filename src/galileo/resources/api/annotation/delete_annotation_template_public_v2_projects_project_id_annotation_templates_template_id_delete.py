...
def _get_kwargs(project_id: str, template_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/public/v2/projects/{project_id}/annotation/templates/{template_id}".format(
...
def sync_detailed(project_id: str, template_id: str, *, client: ApiClient) -> Response[Any | HTTPValidationError]:
...
def sync(project_id: str, template_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Delete Annotation Template
...
async def asyncio(project_id: str, template_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Delete Annotation Template
