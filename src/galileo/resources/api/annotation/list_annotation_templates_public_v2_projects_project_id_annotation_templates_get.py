...
def _get_kwargs(project_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/public/v2/projects/{project_id}/annotation/templates".format(project_id=project_id),
    }
...
def sync_detailed(project_id: str, *, client: ApiClient) -> Response[HTTPValidationError | list[AnnotationTemplateDB]]:
...
def sync(project_id: str, *, client: ApiClient) -> Optional[HTTPValidationError | list[AnnotationTemplateDB]]:
    """List Annotation Templates
...
async def asyncio(project_id: str, *, client: ApiClient) -> Optional[HTTPValidationError | list[AnnotationTemplateDB]]:
    """List Annotation Templates
