...
def _get_kwargs(project_id: str, template_id: str, *, body: AnnotationTemplateUpdate) -> dict[str, Any]:
...
def sync_detailed(
    project_id: str, template_id: str, *, client: ApiClient, body: AnnotationTemplateUpdate
) -> Response[AnnotationTemplateDB | HTTPValidationError]:
