...
def _get_kwargs(*, body: ListAnnotationQueueParams) -> dict[str, Any]:
...
def _parse_response(
    *, client: ApiClient, response: httpx.Response
    ...
    if response.status_code == 200:
        return AnnotationQueueCountResponse.from_dict(response.json())
...
def sync_detailed(
    *, client: ApiClient, body: ListAnnotationQueueParams
) -> Response[AnnotationQueueCountResponse | HTTPValidationError]:
    ...
    Returns
    -------
        Response[Union[AnnotationQueueCountResponse, HTTPValidationError]]
    """
...
def sync(
    *, client: ApiClient, body: ListAnnotationQueueParams
) -> AnnotationQueueCountResponse | HTTPValidationError | None:
    """Count Annotation Queues.
    ...
    Returns
    -------
        Union[AnnotationQueueCountResponse, HTTPValidationError]
    """
