...
def _get_kwargs(queue_id: str, template_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": f"/annotation_queues/{queue_id}/templates/{template_id}",
    }
...
def sync(queue_id: str, template_id: str, *, client: ApiClient) -> Any | HTTPValidationError | None:
    """Delete Queue Template.
...
async def asyncio(queue_id: str, template_id: str, *, client: ApiClient) -> Any | HTTPValidationError | None:
    """Delete Queue Template.
