...
def _get_kwargs(queue_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": f"/annotation_queues/{queue_id}",
    }
...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> AnnotationQueueResponse | HTTPValidationError:
    if response.status_code == 200:
        return AnnotationQueueResponse.from_dict(response.json())
...
def sync(queue_id: str, *, client: ApiClient) -> AnnotationQueueResponse | HTTPValidationError | None:
    """Get Annotation Queue.
...
async def asyncio(queue_id: str, *, client: ApiClient) -> AnnotationQueueResponse | HTTPValidationError | None:
    """Get Annotation Queue.
