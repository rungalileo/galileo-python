...
def _get_kwargs(queue_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": f"/annotation_queues/{queue_id}/templates",
    }
...
def sync(queue_id: str, *, client: ApiClient) -> HTTPValidationError | list["AnnotationTemplateDB"] | None:
    """Get Queue Templates.
...
async def asyncio(queue_id: str, *, client: ApiClient) -> HTTPValidationError | list["AnnotationTemplateDB"] | None:
    """Get Queue Templates.
