...
def _get_kwargs(queue_id: str, user_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": f"/annotation_queues/{queue_id}/users/{user_id}",
    }
...
def sync(queue_id: str, user_id: str, *, client: ApiClient) -> Any | HTTPValidationError | None:
    """Remove Annotation Queue User.
...
async def asyncio(queue_id: str, user_id: str, *, client: ApiClient) -> Any | HTTPValidationError | None:
    """Remove Annotation Queue User.
