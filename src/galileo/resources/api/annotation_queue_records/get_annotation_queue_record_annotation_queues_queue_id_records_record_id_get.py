...
def sync(queue_id: str, record_id: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """Get Annotation Queue Record
...
async def asyncio_detailed(queue_id: str, record_id: str, *, client: ApiClient) -> Response[HTTPValidationError]:
    """Get Annotation Queue Record
...
async def asyncio(queue_id: str, record_id: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """Get Annotation Queue Record
