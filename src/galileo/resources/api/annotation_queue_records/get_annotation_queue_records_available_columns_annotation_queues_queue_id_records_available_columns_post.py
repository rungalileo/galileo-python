...
def _get_kwargs(queue_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": f"/annotation_queues/{queue_id}/records/available_columns",
    }
...
def sync(queue_id: str, *, client: ApiClient) -> HTTPValidationError | LogRecordsAvailableColumnsResponse | None:
    """Get Annotation Queue Records Available Columns.
