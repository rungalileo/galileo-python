...
def _get_kwargs(project_id: str, run_id: str, *, body: ComputeHealthScoreRequest) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": f"/projects/{project_id}/metrics-testing/{run_id}/health-score",
    }
...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> HTTPValidationError | HealthScoreResult:
    if response.status_code == 200:
        return HealthScoreResult.from_dict(response.json())
...
def sync(
    project_id: str, run_id: str, *, client: ApiClient, body: ComputeHealthScoreRequest
) -> HTTPValidationError | HealthScoreResult | None:
    """Compute Health Score Endpoint.
