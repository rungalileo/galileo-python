...
from ... import errors
from ...models.body_validate_code_scorer_public_v2_scorers_code_validate_post import (
...
def _get_kwargs(*, body: BodyValidateCodeScorerPublicV2ScorersCodeValidatePost) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/public/v2/scorers/code/validate",
    }
...
def sync_detailed(
    *, client: ApiClient, body: BodyValidateCodeScorerPublicV2ScorersCodeValidatePost
) -> Response[HTTPValidationError | ValidateCodeScorerResponse]:
    ...
    Args:
        body (BodyValidateCodeScorerPublicV2ScorersCodeValidatePost):
