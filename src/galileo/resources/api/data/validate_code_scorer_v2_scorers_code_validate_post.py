...
from ... import errors
from ...models.body_validate_code_scorer_v2_scorers_code_validate_post import (
...
def _get_kwargs(*, body: BodyValidateCodeScorerV2ScorersCodeValidatePost) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/v2/scorers/code/validate",
    }
...
def sync_detailed(
    *, client: ApiClient, body: BodyValidateCodeScorerV2ScorersCodeValidatePost
) -> Response[HTTPValidationError | ValidateCodeScorerResponse]:
    ...
    Args:
        body (BodyValidateCodeScorerV2ScorersCodeValidatePost):
