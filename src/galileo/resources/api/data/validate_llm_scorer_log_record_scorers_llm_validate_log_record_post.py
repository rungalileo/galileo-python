...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> Optional[Union[HTTPValidationError, ValidateLLMScorerLogRecordResponse]]:
...
def _build_response(*, client: ApiClient, response: httpx.Response) -> Response[Union[HTTPValidationError, ValidateLLMScorerLogRecordResponse]]:
    return Response(
