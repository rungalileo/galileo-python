...
def sync_detailed(*, client: ApiClient, body: ListDatasetParams) -> Response[HTTPValidationError | int]:
    """Count Datasets.
...
def sync(*, client: ApiClient, body: ListDatasetParams) -> HTTPValidationError | int | None:
    """Count Datasets.
...
async def asyncio_detailed(*, client: ApiClient, body: ListDatasetParams) -> Response[HTTPValidationError | int]:
    """Count Datasets.
...
async def asyncio(*, client: ApiClient, body: ListDatasetParams) -> HTTPValidationError | int | None:
    """Count Datasets.
