...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/datasets/{dataset_id}/versions/{version_index}".format(dataset_id=dataset_id,version_index=version_index,),
    }
...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> Optional[Union[DatasetVersionDB, HTTPValidationError]]:
...
def _build_response(*, client: ApiClient, response: httpx.Response) -> Response[Union[DatasetVersionDB, HTTPValidationError]]:
    return Response(
