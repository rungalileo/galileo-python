...
from ...models.body_update_prompt_dataset_projects_project_id_prompt_datasets_dataset_id_put import BodyUpdatePromptDatasetProjectsProjectIdPromptDatasetsDatasetIdPut
...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> Optional[Union[HTTPValidationError, PromptDatasetDB]]:
...
def _build_response(*, client: ApiClient, response: httpx.Response) -> Response[Union[HTTPValidationError, PromptDatasetDB]]:
    return Response(
