...
from ... import errors
from ...models.body_update_prompt_dataset_v2_projects_project_id_prompt_datasets_dataset_id_put import (
...
def _get_kwargs(
    ...
    dataset_id: str,
    *,
    body: BodyUpdatePromptDatasetV2ProjectsProjectIdPromptDatasetsDatasetIdPut | Unset,
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/v2/projects/{project_id}/prompt_datasets/{dataset_id}".format(
