...
from ... import errors
from ...models.body_upload_prompt_evaluation_dataset_public_v2_projects_project_id_prompt_datasets_post import (
...
def _get_kwargs(
    project_id: str,
    *,
    body: BodyUploadPromptEvaluationDatasetPublicV2ProjectsProjectIdPromptDatasetsPost,
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/public/v2/projects/{project_id}/prompt_datasets".format(project_id=project_id),
        "params": params,
    }
