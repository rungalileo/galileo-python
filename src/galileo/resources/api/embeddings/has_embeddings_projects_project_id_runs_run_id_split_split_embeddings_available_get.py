...
from ...models.has_embeddings_response import HasEmbeddingsResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/projects/{project_id}/runs/{run_id}/split/{split}/embeddings/available",
        "params": params,
    }
...
) -> Optional[Union[HTTPValidationError, HasEmbeddingsResponse]]:
    if response.status_code == 200:
        response_200 = HasEmbeddingsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, HasEmbeddingsResponse]]:
    return Response(
...
def sync_detailed(
    ...
    """Has Embeddings
     ...
     Returns whether or not model embeddings are available for this run/split.
...
def sync(
    ...
    Returns:
        Union[HTTPValidationError, HasEmbeddingsResponse]
    """
