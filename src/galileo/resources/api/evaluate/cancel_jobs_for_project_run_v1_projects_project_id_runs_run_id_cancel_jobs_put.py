...
def _get_kwargs(project_id: str, run_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/v1/projects/{project_id}/runs/{run_id}/cancel-jobs".format(project_id=project_id, run_id=run_id),
    }
...
def sync_detailed(project_id: str, run_id: str, *, client: ApiClient) -> Response[Any | HTTPValidationError]:
...
def sync(project_id: str, run_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Cancel Jobs For Project Run
...
async def asyncio_detailed(project_id: str, run_id: str, *, client: ApiClient) -> Response[Any | HTTPValidationError]:
    """Cancel Jobs For Project Run
...
async def asyncio(project_id: str, run_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Cancel Jobs For Project Run
