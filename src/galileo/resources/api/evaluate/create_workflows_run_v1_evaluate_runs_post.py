...
def _get_kwargs(*, body: EvaluateRunRequest) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {"method": RequestMethod.POST, "return_raw_response": True, "path": "/v1/evaluate/runs"}
...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> EvaluateRunResponse | HTTPValidationError:
...
) -> Response[EvaluateRunResponse | HTTPValidationError]:
    return Response(
...
def sync_detailed(
    *, client: ApiClient, body: EvaluateRunRequest
) -> Response[EvaluateRunResponse | HTTPValidationError]:
...
def sync(*, client: ApiClient, body: EvaluateRunRequest) -> Optional[EvaluateRunResponse | HTTPValidationError]:
    """Create Workflows Run
    ...
    Returns:
        EvaluateRunResponse | HTTPValidationError
    """
...
async def asyncio(
    *, client: ApiClient, body: EvaluateRunRequest
) -> Optional[EvaluateRunResponse | HTTPValidationError]:
    """Create Workflows Run
