...
from ... import errors
from ...models.evaluate_run_results_request import EvaluateRunResultsRequest
...
def _get_kwargs(*, body: EvaluateRunResultsRequest) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/public/v1/evaluate/run-workflows",
    }
...
def sync_detailed(
    *, client: ApiClient, body: EvaluateRunResultsRequest
) -> Response[HTTPValidationError | WorkflowsReadResponse]:
