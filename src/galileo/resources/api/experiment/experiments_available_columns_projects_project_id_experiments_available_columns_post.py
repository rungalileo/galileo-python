...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> Optional[Union[ExperimentsAvailableColumnsResponse, HTTPValidationError]]:
...
def _build_response(*, client: ApiClient, response: httpx.Response) -> Response[Union[ExperimentsAvailableColumnsResponse, HTTPValidationError]]:
    return Response(
