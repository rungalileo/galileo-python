...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/experiments/{experiment_id}/metrics".format(project_id=project_id,experiment_id=experiment_id,),
    }
...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> Optional[Union[ExperimentMetricsResponse, HTTPValidationError]]:
...
def _build_response(*, client: ApiClient, response: httpx.Response) -> Response[Union[ExperimentMetricsResponse, HTTPValidationError]]:
    return Response(
