...
def _get_kwargs(project_id: str, *, body: ExperimentSearchRequest) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/projects/{project_id}/experiments/search".format(project_id=project_id),
    }
...
def sync_detailed(
    project_id: str, *, client: ApiClient, body: ExperimentSearchRequest
) -> Response[Union[HTTPValidationError, ListExperimentResponse]]:
    """Search Experiments
