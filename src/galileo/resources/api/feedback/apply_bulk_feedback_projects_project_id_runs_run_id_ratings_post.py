...
def _get_kwargs(project_id: str, run_id: str, *, body: BulkFeedbackRequest) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/runs/{run_id}/ratings".format(project_id=project_id, run_id=run_id),
    }
...
def sync_detailed(
    project_id: str, run_id: str, *, client: ApiClient, body: BulkFeedbackRequest
) -> Response[HTTPValidationError | list[BulkFeedbackRatingStatus]]:
    """Apply Bulk Feedback
