...
def _get_kwargs(project_id: str, run_id: str, template_id: str, index: int) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/runs/{run_id}/feedback/templates/{template_id}/index/{index}/rating".format(
            project_id=project_id, run_id=run_id, template_id=template_id, index=index
        ),
    }
...
def sync_detailed(
    project_id: str, run_id: str, template_id: str, index: int, *, client: ApiClient
