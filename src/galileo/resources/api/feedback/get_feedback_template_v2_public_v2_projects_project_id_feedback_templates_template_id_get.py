...
def _get_kwargs(project_id: str, template_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/public/v2/projects/{project_id}/feedback/templates/{template_id}".format(
...
def sync_detailed(project_id: str, template_id: str, *, client: ApiClient) -> Response[HTTPValidationError]:
...
def sync(project_id: str, template_id: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """Get Feedback Template V2
...
async def asyncio_detailed(project_id: str, template_id: str, *, client: ApiClient) -> Response[HTTPValidationError]:
    """Get Feedback Template V2
...
async def asyncio(project_id: str, template_id: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """Get Feedback Template V2
