...
def _get_kwargs(project_id: str) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {"method": "get", "url": f"/projects/{project_id}/feedback/templates"}
...
) -> Optional[Union[HTTPValidationError, list["FeedbackTemplateDB"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = FeedbackTemplateDB.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, list["FeedbackTemplateDB"]]]:
    return Response(
...
def sync(
    ...
    Returns:
        Union[HTTPValidationError, list['FeedbackTemplateDB']]
    """
