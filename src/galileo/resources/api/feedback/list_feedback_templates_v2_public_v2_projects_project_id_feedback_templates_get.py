...
def _get_kwargs(project_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/public/v2/projects/{project_id}/feedback/templates".format(project_id=project_id),
    }
...
def sync(project_id: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """List Feedback Templates V2
...
async def asyncio_detailed(project_id: str, *, client: ApiClient) -> Response[HTTPValidationError]:
    """List Feedback Templates V2
...
async def asyncio(project_id: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """List Feedback Templates V2
