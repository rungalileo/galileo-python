...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> HTTPValidationError | list[GroupMemberDB]:
...
) -> Response[HTTPValidationError | list[GroupMemberDB]]:
    return Response(
...
def sync_detailed(
    group_id: str, *, client: ApiClient, body: list[GroupMemberCreate]
) -> Response[HTTPValidationError | list[GroupMemberDB]]:
    """Add User To Group
...
def sync(
    group_id: str, *, client: ApiClient, body: list[GroupMemberCreate]
) -> Optional[HTTPValidationError | list[GroupMemberDB]]:
    """Add User To Group
    ...
    Returns:
        HTTPValidationError | list[GroupMemberDB]
    """
