...
def sync_detailed(group_id: str, *, client: ApiClient) -> Response[Any | HTTPValidationError]:
    """Delete Group
...
def sync(group_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Delete Group
...
async def asyncio_detailed(group_id: str, *, client: ApiClient) -> Response[Any | HTTPValidationError]:
    """Delete Group
...
async def asyncio(group_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Delete Group
