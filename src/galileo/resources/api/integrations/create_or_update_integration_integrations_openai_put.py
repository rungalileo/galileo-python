...
def sync_detailed(
    *, client: AuthenticatedClient, body: OpenAIIntegrationCreate
) -> Response[Union[Any, HTTPValidationError]]:
...
def sync(*, client: AuthenticatedClient, body: OpenAIIntegrationCreate) -> Optional[Union[Any, HTTPValidationError]]:
    """Create Or Update Integration
