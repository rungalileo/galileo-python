...
def _get_kwargs(name: str, *, body: CustomIntegrationCreate) -> dict[str, Any]:
...
def sync_detailed(
    name: str, *, client: ApiClient, body: CustomIntegrationCreate
) -> Response[Union[HTTPValidationError, IntegrationDB]]:
...
def sync(
    ...
    return sync_detailed(name=name, client=client, body=body).parsed
...
async def asyncio(
    ...
    return (await asyncio_detailed(name=name, client=client, body=body)).parsed
