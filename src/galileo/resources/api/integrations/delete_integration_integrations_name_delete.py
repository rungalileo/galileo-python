...
def sync(name: IntegrationProvider, *, client: ApiClient) -> Any | HTTPValidationError | None:
    """Delete Integration.
...
async def asyncio(name: IntegrationProvider, *, client: ApiClient) -> Any | HTTPValidationError | None:
    """Delete Integration.
