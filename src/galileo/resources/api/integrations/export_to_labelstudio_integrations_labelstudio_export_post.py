...
def _get_kwargs(*, body: LabelStudioExportRequest) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {"method": "post", "url": "/integrations/labelstudio/export"}
...
def sync_detailed(
    *, client: AuthenticatedClient, body: LabelStudioExportRequest
) -> Response[Union[Any, HTTPValidationError]]:
...
def sync(*, client: AuthenticatedClient, body: LabelStudioExportRequest) -> Optional[Union[Any, HTTPValidationError]]:
    """Export To Labelstudio
