...
def _get_kwargs(name: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": f"/integrations/custom/{name}/definition",
    }
...
def sync(name: str, *, client: ApiClient) -> HTTPValidationError | None:
    """Get definition of a named custom integration.
...
async def asyncio(name: str, *, client: ApiClient) -> HTTPValidationError | None:
    """Get definition of a named custom integration.
