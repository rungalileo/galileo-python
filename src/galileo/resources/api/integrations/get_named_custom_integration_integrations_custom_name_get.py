...
def _get_kwargs(name: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": f"/integrations/custom/{name}",
    }
...
def sync(name: str, *, client: ApiClient) -> HTTPValidationError | IntegrationDB | None:
    """Get a named custom integration.
...
async def asyncio(name: str, *, client: ApiClient) -> HTTPValidationError | IntegrationDB | None:
    """Get a named custom integration.
