...
def _get_kwargs(name: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": f"/integrations/custom/{name}/status",
    }
...
def _parse_response(
    *, client: ApiClient, response: httpx.Response
    ...
    if response.status_code == 200:
        return GetNamedCustomIntegrationStatusIntegrationsCustomNameStatusGetResponseGetNamedCustomIntegrationStatusIntegrationsCustomNameStatusGet.from_dict(
            response.json()
        )
