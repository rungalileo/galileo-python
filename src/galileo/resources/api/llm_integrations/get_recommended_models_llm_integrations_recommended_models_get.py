...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> RecommendedModelsResponse:
    if response.status_code == 200:
        return RecommendedModelsResponse.from_dict(response.json())
...
def sync(*, client: ApiClient) -> RecommendedModelsResponse | None:
    """Get Recommended Models.
...
async def asyncio(*, client: ApiClient) -> RecommendedModelsResponse | None:
    """Get Recommended Models.
