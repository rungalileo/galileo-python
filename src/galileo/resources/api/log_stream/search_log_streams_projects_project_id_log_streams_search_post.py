...
from ...models.log_stream_search_request import LogStreamSearchRequest
from ...types import Response


def _get_kwargs(project_id: str, *, body: LogStreamSearchRequest) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/projects/{project_id}/log_streams/search".format(project_id=project_id),
    }
...
def sync_detailed(
    project_id: str, *, client: ApiClient, body: LogStreamSearchRequest
) -> Response[Union[HTTPValidationError, ListLogStreamResponse]]:
    """Search Log Streams
