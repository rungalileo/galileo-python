...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/log_streams/{log_stream_id}".format(project_id=project_id,log_stream_id=log_stream_id,),
    }
...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> Optional[Union[HTTPValidationError, LogStreamResponse]]:
...
def _build_response(*, client: ApiClient, response: httpx.Response) -> Response[Union[HTTPValidationError, LogStreamResponse]]:
    return Response(
