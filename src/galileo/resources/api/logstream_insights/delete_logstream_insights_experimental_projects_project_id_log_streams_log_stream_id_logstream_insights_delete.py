...
def sync_detailed(
    ...
    """Delete Logstream Insights

     Delete logstream insights for a specific project and run.
...
def sync(project_id: str, log_stream_id: str, *, client: ApiClient) -> Optional[EmptyResponse | HTTPValidationError]:
    """Delete Logstream Insights
