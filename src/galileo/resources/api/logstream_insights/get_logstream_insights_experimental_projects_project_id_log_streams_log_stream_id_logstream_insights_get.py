...
from ...models.logstream_insights_response import LogstreamInsightsResponse
...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> HTTPValidationError | LogstreamInsightsResponse:
    if response.status_code == 200:
        response_200 = LogstreamInsightsResponse.from_dict(response.json())
...
) -> Response[HTTPValidationError | LogstreamInsightsResponse]:
    return Response(
...
def sync_detailed(
    ...
    """Get Logstream Insights

     Get logstream insights for a specific project and run.
...
def sync(
    project_id: str, log_stream_id: str, *, client: ApiClient
) -> Optional[HTTPValidationError | LogstreamInsightsResponse]:
    """Get Logstream Insights
    ...
    Returns:
        HTTPValidationError | LogstreamInsightsResponse
    """
