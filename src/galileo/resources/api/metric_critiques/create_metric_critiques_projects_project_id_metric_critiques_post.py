...
def _get_kwargs(project_id: str, *, body: CreateMetricCritiquesRequest) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/metric_critiques".format(project_id=project_id),
    }
...
def sync_detailed(
    project_id: str, *, client: ApiClient, body: CreateMetricCritiquesRequest
...
def sync(project_id: str, *, client: ApiClient, body: CreateMetricCritiquesRequest) -> Optional[HTTPValidationError]:
    """Create Metric Critiques
