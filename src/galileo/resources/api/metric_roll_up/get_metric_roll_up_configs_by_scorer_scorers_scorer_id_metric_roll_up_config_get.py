...
def sync_detailed(scorer_id: str, *, client: ApiClient) -> Response[HTTPValidationError | MetricRollUpConfigResponse]:
    """Get Metric Roll Up Configs By Scorer

     Get all metric roll up configurations for a specific scorer.
...
def sync(scorer_id: str, *, client: ApiClient) -> Optional[HTTPValidationError | MetricRollUpConfigResponse]:
    """Get Metric Roll Up Configs By Scorer
...
async def asyncio(scorer_id: str, *, client: ApiClient) -> Optional[HTTPValidationError | MetricRollUpConfigResponse]:
    """Get Metric Roll Up Configs By Scorer
