...
def _get_kwargs(project_id: str, run_id: str) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {"method": "get", "url": f"/projects/{project_id}/runs/{run_id}/model"}
...
def sync_detailed(
    ...
    """Get Model By Run
     ...
     Gets a model from the database and returns the presigned url to download it :param run_id: run id
    :param db_read:
