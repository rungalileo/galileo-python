...
def _get_kwargs(project_id: str, *, body: TransactionRowsRequestBody | Unset) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/projects/{project_id}/observe/delete".format(project_id=project_id),
    }
...
def sync_detailed(
    project_id: str, *, client: ApiClient, body: TransactionRowsRequestBody | Unset
