...
def _get_kwargs(project_id: str, monitor_alert_config_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/public/v2/projects/{project_id}/alerts/{monitor_alert_config_id}".format(
            project_id=project_id, monitor_alert_config_id=monitor_alert_config_id
        ),
    }
...
def sync_detailed(project_id: str, monitor_alert_config_id: str, *, client: ApiClient) -> Response[HTTPValidationError]:
    """Get Alert By Id
...
def sync(project_id: str, monitor_alert_config_id: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """Get Alert By Id
...
async def asyncio_detailed(
    project_id: str, monitor_alert_config_id: str, *, client: ApiClient
) -> Response[HTTPValidationError]:
    """Get Alert By Id
...
async def asyncio(project_id: str, monitor_alert_config_id: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """Get Alert By Id
