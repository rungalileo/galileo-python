...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/observe/filter_options".format(project_id=project_id),
        "params": params,
    }
...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> FilterOptionsResponse | HTTPValidationError:
...
) -> Response[FilterOptionsResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    start_time: datetime.datetime | None | Unset = UNSET,
    end_time: datetime.datetime | None | Unset = UNSET,
) -> Optional[FilterOptionsResponse | HTTPValidationError]:
    """Get Filter Options
    ...
    Returns:
        FilterOptionsResponse | HTTPValidationError
    """
