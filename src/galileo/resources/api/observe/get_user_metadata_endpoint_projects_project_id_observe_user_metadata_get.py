...
def _get_kwargs(project_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/observe/user_metadata".format(project_id=project_id),
    }
...
def sync_detailed(project_id: str, *, client: ApiClient) -> Response[HTTPValidationError | list[str]]:
...
def sync(project_id: str, *, client: ApiClient) -> Optional[HTTPValidationError | list[str]]:
    """Get User Metadata Endpoint
...
async def asyncio_detailed(project_id: str, *, client: ApiClient) -> Response[HTTPValidationError | list[str]]:
    """Get User Metadata Endpoint
...
async def asyncio(project_id: str, *, client: ApiClient) -> Optional[HTTPValidationError | list[str]]:
    """Get User Metadata Endpoint
