...
def _get_kwargs(project_id: str, *, body: TransactionRecordBatch) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/observe/ingest".format(project_id=project_id),
    }
...
def sync_detailed(
    project_id: str, *, client: ApiClient, body: TransactionRecordBatch
...
def sync(project_id: str, *, client: ApiClient, body: TransactionRecordBatch) -> Optional[Any | HTTPValidationError]:
    """Ingest
