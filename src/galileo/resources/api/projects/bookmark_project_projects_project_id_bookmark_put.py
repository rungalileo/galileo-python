...
def _get_kwargs(project_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/bookmark".format(project_id=project_id),
    }
...
def sync_detailed(project_id: str, *, client: ApiClient) -> Response[Any | HTTPValidationError]:
    """Bookmark Project
...
def sync(project_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Bookmark Project
...
async def asyncio_detailed(project_id: str, *, client: ApiClient) -> Response[Any | HTTPValidationError]:
    """Bookmark Project
...
async def asyncio(project_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Bookmark Project
