...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> Optional[Union[HTTPValidationError, ProjectCreateResponse]]:
...
def _build_response(*, client: ApiClient, response: httpx.Response) -> Response[Union[HTTPValidationError, ProjectCreateResponse]]:
    return Response(
