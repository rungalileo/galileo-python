...
def _get_kwargs(project_id: str, training_or_inference: DatasetType, *, body: ValidationRequest) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/projects/{project_id}/{training_or_inference}/validate_dataset",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ValidationResponse.from_dict(response.json())
...
def sync(
    ...
    Returns:
        Union[HTTPValidationError, ValidationResponse]
    """
