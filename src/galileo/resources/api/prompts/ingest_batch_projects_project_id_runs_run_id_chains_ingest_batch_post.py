...
def _get_kwargs(project_id: str, run_id: str, *, body: PromptChainIngestBatchRequest) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/runs/{run_id}/chains/ingest/batch".format(project_id=project_id, run_id=run_id),
    }
...
) -> HTTPValidationError | PromptChainIngestBatchResponse:
...
def _build_response(
    *, client: ApiClient, response: httpx.Response
) -> Response[HTTPValidationError | PromptChainIngestBatchResponse]:
    return Response(
...
def sync_detailed(
    project_id: str, run_id: str, *, client: ApiClient, body: PromptChainIngestBatchRequest
) -> Response[HTTPValidationError | PromptChainIngestBatchResponse]:
    """Ingest Batch
...
def sync(
    project_id: str, run_id: str, *, client: ApiClient, body: PromptChainIngestBatchRequest
) -> Optional[HTTPValidationError | PromptChainIngestBatchResponse]:
    """Ingest Batch
