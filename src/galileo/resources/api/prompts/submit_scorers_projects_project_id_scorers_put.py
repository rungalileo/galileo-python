...
def _get_kwargs(project_id: str, *, body: CreateComputeScoreRequest) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/scorers".format(project_id=project_id),
    }
...
def sync_detailed(
    project_id: str, *, client: ApiClient, body: CreateComputeScoreRequest
...
def sync(project_id: str, *, client: ApiClient, body: CreateComputeScoreRequest) -> Optional[Any | HTTPValidationError]:
    """Submit Scorers
