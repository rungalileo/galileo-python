...
def _get_kwargs(project_id: str, run_id: str, tag_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/runs/{run_id}/tags/{tag_id}".format(
            project_id=project_id, run_id=run_id, tag_id=tag_id
        ),
    }
...
def sync_detailed(
    project_id: str, run_id: str, tag_id: str, *, client: ApiClient
) -> Response[HTTPValidationError | RunTagDB]:
    """Get Run Tag

     Gets a tag for a given project_id/run_id.
...
def sync(project_id: str, run_id: str, tag_id: str, *, client: ApiClient) -> Optional[HTTPValidationError | RunTagDB]:
    """Get Run Tag
