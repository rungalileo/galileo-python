...
def _get_kwargs(project_id: str, run_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/runs/{run_id}/tags".format(project_id=project_id, run_id=run_id),
    }
...
def sync_detailed(project_id: str, run_id: str, *, client: ApiClient) -> Response[HTTPValidationError | list[RunTagDB]]:
    """Get Run Tags

     Gets tags for a given project_id/run_id.
...
def sync(project_id: str, run_id: str, *, client: ApiClient) -> Optional[HTTPValidationError | list[RunTagDB]]:
    """Get Run Tags
...
async def asyncio(project_id: str, run_id: str, *, client: ApiClient) -> Optional[HTTPValidationError | list[RunTagDB]]:
    """Get Run Tags
