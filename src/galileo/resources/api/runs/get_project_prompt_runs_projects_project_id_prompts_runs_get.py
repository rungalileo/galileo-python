...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/prompts/runs".format(project_id=project_id),
        "params": params,
    }
...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> GetPromptRunsResponse | HTTPValidationError:
...
) -> Response[GetPromptRunsResponse | HTTPValidationError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    starting_token: int | Unset = 0,
    limit: int | Unset = 100,
) -> Optional[GetPromptRunsResponse | HTTPValidationError]:
    """Get Project Prompt Runs
    ...
    Returns:
        GetPromptRunsResponse | HTTPValidationError
    """
