...
def _get_kwargs(project_id: str, run_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/runs/{run_id}/prompts/metrics".format(project_id=project_id, run_id=run_id),
    }
...
def sync(project_id: str, run_id: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """Get Prompt Aggregate Metrics As Singleton Columns
...
async def asyncio_detailed(project_id: str, run_id: str, *, client: ApiClient) -> Response[HTTPValidationError]:
    """Get Prompt Aggregate Metrics As Singleton Columns
...
async def asyncio(project_id: str, run_id: str, *, client: ApiClient) -> Optional[HTTPValidationError]:
    """Get Prompt Aggregate Metrics As Singleton Columns
