...
def _get_kwargs(project_id: str, run_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/projects/{project_id}/runs/{run_id}/inference_names".format(project_id=project_id, run_id=run_id),
    }
...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> HTTPValidationError | InferenceNamesResponse:
...
) -> Response[HTTPValidationError | InferenceNamesResponse]:
    return Response(
...
def sync(project_id: str, run_id: str, *, client: ApiClient) -> Optional[HTTPValidationError | InferenceNamesResponse]:
    """Get Run Inference Names
    ...
    Returns:
        HTTPValidationError | InferenceNamesResponse
    """
...
async def asyncio(
    project_id: str, run_id: str, *, client: ApiClient
) -> Optional[HTTPValidationError | InferenceNamesResponse]:
    """Get Run Inference Names
