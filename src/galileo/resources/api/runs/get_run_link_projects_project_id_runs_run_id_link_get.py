...
def _get_kwargs(project_id: str, run_id: str) -> dict[str, Any]:
    _kwargs: dict[str, Any] = {"method": "get", "url": f"/projects/{project_id}/runs/{run_id}/link"}
...
) -> Optional[Union[HTTPValidationError, RunLinkResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, RunLinkResponse]]:
    return Response(
...
def sync(
    ...
    Returns:
        Union[HTTPValidationError, RunLinkResponse]
    """
