...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> HTTPValidationError | RunMetricDB:
...
def _build_response(*, client: ApiClient, response: httpx.Response) -> Response[HTTPValidationError | RunMetricDB]:
    return Response(
...
def sync_detailed(
    project_id: str, run_id: str, *, client: ApiClient, body: RunMetricCreateRequest
) -> Response[HTTPValidationError | RunMetricDB]:
    """Set Metric For Run
...
def sync(
    project_id: str, run_id: str, *, client: ApiClient, body: RunMetricCreateRequest
) -> Optional[HTTPValidationError | RunMetricDB]:
    """Set Metric For Run
    ...
    Returns:
        HTTPValidationError | RunMetricDB
    """
