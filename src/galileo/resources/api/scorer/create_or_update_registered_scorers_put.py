...
) -> CreateUpdateRegisteredScorerResponse | HTTPValidationError:
...
def _build_response(
    *, client: ApiClient, response: httpx.Response
) -> Response[CreateUpdateRegisteredScorerResponse | HTTPValidationError]:
    return Response(
...
def sync_detailed(
    *, client: ApiClient, body: BodyCreateOrUpdateRegisteredScorersPut, name: str
) -> Response[CreateUpdateRegisteredScorerResponse | HTTPValidationError]:
    """Create Or Update
...
def sync(
    *, client: ApiClient, body: BodyCreateOrUpdateRegisteredScorersPut, name: str
) -> Optional[CreateUpdateRegisteredScorerResponse | HTTPValidationError]:
    """Create Or Update
