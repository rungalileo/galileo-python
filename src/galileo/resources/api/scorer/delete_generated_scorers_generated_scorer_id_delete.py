...
def _get_kwargs(generated_scorer_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/generated-scorers/{generated_scorer_id}".format(generated_scorer_id=generated_scorer_id),
    }
...
def sync_detailed(generated_scorer_id: str, *, client: ApiClient) -> Response[Any | HTTPValidationError]:
    """Delete
...
def sync(generated_scorer_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Delete
...
async def asyncio_detailed(generated_scorer_id: str, *, client: ApiClient) -> Response[Any | HTTPValidationError]:
    """Delete
...
async def asyncio(generated_scorer_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Delete
