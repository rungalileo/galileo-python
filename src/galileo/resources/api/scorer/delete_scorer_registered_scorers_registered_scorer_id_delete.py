...
def _get_kwargs(registered_scorer_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/registered-scorers/{registered_scorer_id}".format(registered_scorer_id=registered_scorer_id),
    }
...
def sync_detailed(registered_scorer_id: str, *, client: ApiClient) -> Response[Any | HTTPValidationError]:
    """Delete Scorer
...
def sync(registered_scorer_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Delete Scorer
...
async def asyncio_detailed(registered_scorer_id: str, *, client: ApiClient) -> Response[Any | HTTPValidationError]:
    """Delete Scorer
...
async def asyncio(registered_scorer_id: str, *, client: ApiClient) -> Optional[Any | HTTPValidationError]:
    """Delete Scorer
