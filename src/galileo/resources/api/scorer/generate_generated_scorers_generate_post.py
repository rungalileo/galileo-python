...
from ... import errors
from ...models.generated_scorer_generate_configuration import GeneratedScorerGenerateConfiguration
from ...models.generation_response import GenerationResponse
from ...models.http_validation_error import HTTPValidationError
from ...types import Response


def _get_kwargs(*, body: GeneratedScorerGenerateConfiguration) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/generated-scorers/generate",
    }
...
def sync_detailed(
    *, client: ApiClient, body: GeneratedScorerGenerateConfiguration
) -> Response[GenerationResponse | HTTPValidationError]:
    """Generate

    Args:
        body (GeneratedScorerGenerateConfiguration): Info necessary to generate a scorer from
            instructions.
