...
) -> HTTPValidationError | ListGeneratedScorersResponse:
...
def _build_response(
    *, client: ApiClient, response: httpx.Response
) -> Response[HTTPValidationError | ListGeneratedScorersResponse]:
    return Response(
...
def sync(
    *, client: ApiClient, starting_token: int | Unset = 0, limit: int | Unset = 100
) -> Optional[HTTPValidationError | ListGeneratedScorersResponse]:
    """Get All
