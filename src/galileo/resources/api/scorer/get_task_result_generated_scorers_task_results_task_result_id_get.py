...
def _get_kwargs(task_result_id: str) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        ...
        "path": "/generated-scorers/task-results/{task_result_id}".format(task_result_id=task_result_id),
    }
...
) -> GeneratedScorerTaskResultResponse | HTTPValidationError:
...
def _build_response(
    *, client: ApiClient, response: httpx.Response
) -> Response[GeneratedScorerTaskResultResponse | HTTPValidationError]:
    return Response(
...
def sync_detailed(
    task_result_id: str, *, client: ApiClient
) -> Response[GeneratedScorerTaskResultResponse | HTTPValidationError]:
    """Get Task Result
...
def sync(
    task_result_id: str, *, client: ApiClient
) -> Optional[GeneratedScorerTaskResultResponse | HTTPValidationError]:
    """Get Task Result
