...
from ... import errors
from ...models.generated_scorer_validation_request import GeneratedScorerValidationRequest
from ...models.generated_scorer_validation_response import GeneratedScorerValidationResponse
from ...models.http_validation_error import HTTPValidationError
from ...types import Response


def _get_kwargs(*, body: GeneratedScorerValidationRequest) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": RequestMethod.POST,
        "return_raw_response": True,
        "path": "/generated-scorers/validate",
    }
...
def sync_detailed(
    *, client: ApiClient, body: GeneratedScorerValidationRequest
) -> Response[GeneratedScorerValidationResponse | HTTPValidationError]:
    """Validate

    Args:
        body (GeneratedScorerValidationRequest): Info necessary to execute a generated scorer
            validation job.
