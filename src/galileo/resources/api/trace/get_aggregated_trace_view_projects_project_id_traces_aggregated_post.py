...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> Optional[Union[AggregatedTraceViewResponse, HTTPValidationError]]:
...
def _build_response(*, client: ApiClient, response: httpx.Response) -> Response[Union[AggregatedTraceViewResponse, HTTPValidationError]]:
    return Response(
