...
) -> HTTPValidationError | Union["ExtendedTraceRecordWithChildren", "StubTraceRecord"]:
        ...
        def _parse_response_200(data: object) -> Union["ExtendedTraceRecordWithChildren", "StubTraceRecord"]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return ExtendedTraceRecordWithChildren.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return StubTraceRecord.from_dict(data)
...
def _build_response(
    *, client: ApiClient, response: httpx.Response
) -> Response[HTTPValidationError | Union["ExtendedTraceRecordWithChildren", "StubTraceRecord"]]:
    return Response(
...
def sync(
    project_id: str, trace_id: str, *, client: ApiClient, include_presigned_urls: Unset | bool = False
) -> HTTPValidationError | Union["ExtendedTraceRecordWithChildren", "StubTraceRecord"] | None:
    """Get Trace.
