...
def _parse_response(*, client: ApiClient, response: httpx.Response) -> Optional[Union[ExtendedTraceRecordWithChildren, HTTPValidationError]]:
...
def _build_response(*, client: ApiClient, response: httpx.Response) -> Response[Union[ExtendedTraceRecordWithChildren, HTTPValidationError]]:
    return Response(
