...
def sync_detailed(*, client: ApiClient, user_email: str) -> Response[Any | HTTPValidationError]:
    """Request Access
    ...
    `email_is_verified=None`, which signifies that the user has requested access but hasn't been invited
    yet.
...
def sync(*, client: ApiClient, user_email: str) -> Optional[Any | HTTPValidationError]:
    """Request Access
...
async def asyncio_detailed(*, client: ApiClient, user_email: str) -> Response[Any | HTTPValidationError]:
    """Request Access
...
async def asyncio(*, client: ApiClient, user_email: str) -> Optional[Any | HTTPValidationError]:
    """Request Access
