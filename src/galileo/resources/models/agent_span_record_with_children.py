...
@_attrs_define
class AgentSpanRecordWithChildren:
    """
    Attributes:
        ...
        user_metadata (Union[Unset, AgentSpanRecordWithChildrenUserMetadata]): Metadata associated with this trace or
            span.
    """
    ...
    user_metadata: Union[Unset, "AgentSpanRecordWithChildrenUserMetadata"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metric_info, Unset):
            metric_info = UNSET
        elif isinstance(self.metric_info, AgentSpanRecordWithChildrenMetricInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_metadata: Union[Unset, AgentSpanRecordWithChildrenDatasetMetadata]
        if isinstance(_dataset_metadata, Unset):
            dataset_metadata = UNSET
        else:
            dataset_metadata = AgentSpanRecordWithChildrenDatasetMetadata.from_dict(_dataset_metadata)
        ...
        def _parse_metric_info(data: object) -> Union["AgentSpanRecordWithChildrenMetricInfoType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metric_info_type_0 = AgentSpanRecordWithChildrenMetricInfoType0.from_dict(data)

                return metric_info_type_0
            except:  # noqa: E722
                pass
            return cast(Union["AgentSpanRecordWithChildrenMetricInfoType0", None, Unset], data)
        ...
        user_metadata: Union[Unset, AgentSpanRecordWithChildrenUserMetadata]
        if isinstance(_user_metadata, Unset):
            user_metadata = UNSET
        else:
            user_metadata = AgentSpanRecordWithChildrenUserMetadata.from_dict(_user_metadata)

        agent_span_record_with_children = cls(
            id=id,
            input_=input_,
            parent_id=parent_id,
            project_id=project_id,
        ...
        agent_span_record_with_children.additional_properties = d
        return agent_span_record_with_children
