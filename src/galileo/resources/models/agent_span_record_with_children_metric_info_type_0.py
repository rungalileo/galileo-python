...
T = TypeVar("T", bound="AgentSpanRecordWithChildrenMetricInfoType0")


@_attrs_define
class AgentSpanRecordWithChildrenMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        agent_span_record_with_children_metric_info_type_0 = cls()
        ...
        agent_span_record_with_children_metric_info_type_0.additional_properties = additional_properties
        return agent_span_record_with_children_metric_info_type_0
