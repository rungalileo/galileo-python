...
if TYPE_CHECKING:
    from ..models.agent_step_input_type_3 import AgentStepInputType3
    from ..models.agent_step_input_type_7_item import AgentStepInputType7Item
    from ..models.agent_step_input_type_8_item import AgentStepInputType8Item
    from ..models.agent_step_metadata import AgentStepMetadata
    from ..models.agent_step_output_type_3 import AgentStepOutputType3
    from ..models.agent_step_output_type_7_item import AgentStepOutputType7Item
    from ..models.agent_step_output_type_8_item import AgentStepOutputType8Item
    from ..models.agent_step_redacted_input_type_3 import AgentStepRedactedInputType3
    from ..models.agent_step_redacted_input_type_7_item import AgentStepRedactedInputType7Item
    from ..models.agent_step_redacted_input_type_8_item import AgentStepRedactedInputType8Item
    from ..models.agent_step_redacted_output_type_3 import AgentStepRedactedOutputType3
    from ..models.agent_step_redacted_output_type_7_item import AgentStepRedactedOutputType7Item
    from ..models.agent_step_redacted_output_type_8_item import AgentStepRedactedOutputType8Item
...
class AgentStep:
    """
    Attributes:
        input_ (AgentStepInputType3 | Document | list[AgentStepInputType7Item] | list[AgentStepInputType8Item] |
            list[Document] | list[MessagesListItem] | list[str] | MessagesListItem | str): Input to the step.
        type_ (Literal['agent'] | Unset): Type of the step. By default, it is set to agent. Default: 'agent'.
        redacted_input (AgentStepRedactedInputType3 | Document | list[AgentStepRedactedInputType7Item] |
            list[AgentStepRedactedInputType8Item] | list[Document] | list[MessagesListItem] | list[str] | MessagesListItem |
            None | str | Unset): Redacted input of the step. This is used to redact sensitive information.
        output (AgentStepOutputType3 | Document | list[AgentStepOutputType7Item] | list[AgentStepOutputType8Item] |
            list[Document] | list[MessagesListItem] | list[str] | MessagesListItem | str | Unset): Output of the step.
            Default: ''.
        redacted_output (AgentStepRedactedOutputType3 | Document | list[AgentStepRedactedOutputType7Item] |
            list[AgentStepRedactedOutputType8Item] | list[Document] | list[MessagesListItem] | list[str] | MessagesListItem
        ...
        metadata (AgentStepMetadata | Unset): Metadata associated with this step.
    ...
    input_: (
        AgentStepInputType3
        | Document
        | list[AgentStepInputType7Item]
        | list[AgentStepInputType8Item]
        | list[Document]
    ...
    redacted_input: (
        ...
        | Document
        | list[AgentStepRedactedInputType7Item]
        | list[AgentStepRedactedInputType8Item]
        | list[Document]
        | list[MessagesListItem]
        | list[str]
        | MessagesListItem
    ...
    output: (
        ...
        | Document
        | list[AgentStepOutputType7Item]
        | list[AgentStepOutputType8Item]
        | list[Document]
        | list[MessagesListItem]
        | list[str]
        | MessagesListItem
    ...
    redacted_output: (
        ...
        | Document
        | list[AgentStepRedactedOutputType7Item]
        | list[AgentStepRedactedOutputType8Item]
        | list[Document]
        | list[MessagesListItem]
        | list[str]
        | MessagesListItem
    ...
    metadata: AgentStepMetadata | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.input_, Document):
            ...
            input_ = self.input_.to_dict()
        elif isinstance(self.input_, AgentStepInputType3):
            input_ = self.input_.to_dict()
        ...
        if isinstance(self.redacted_input, Unset):
            ...
            redacted_input = self.redacted_input.to_dict()
        elif isinstance(self.redacted_input, AgentStepRedactedInputType3):
            redacted_input = self.redacted_input.to_dict()
        ...
        if isinstance(self.output, Unset):
            ...
            output = self.output.to_dict()
        elif isinstance(self.output, AgentStepOutputType3):
            output = self.output.to_dict()
        ...
        if isinstance(self.redacted_output, Unset):
            ...
            redacted_output = self.redacted_output.to_dict()
        elif isinstance(self.redacted_output, AgentStepRedactedOutputType3):
            redacted_output = self.redacted_output.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_input_(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                input_type_3 = AgentStepInputType3.from_dict(data)
            ...
            try:
                ...
                for input_type_7_item_data in _input_type_7:
                    input_type_7_item = AgentStepInputType7Item.from_dict(input_type_7_item_data)
            ...
            try:
                ...
                for input_type_8_item_data in _input_type_8:
                    input_type_8_item = AgentStepInputType8Item.from_dict(input_type_8_item_data)
        ...
        def _parse_redacted_input(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                redacted_input_type_3 = AgentStepRedactedInputType3.from_dict(data)
            ...
            try:
                ...
                for redacted_input_type_7_item_data in _redacted_input_type_7:
                    redacted_input_type_7_item = AgentStepRedactedInputType7Item.from_dict(
            ...
            try:
                ...
                for redacted_input_type_8_item_data in _redacted_input_type_8:
                    redacted_input_type_8_item = AgentStepRedactedInputType8Item.from_dict(
        ...
        def _parse_output(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                output_type_3 = AgentStepOutputType3.from_dict(data)
            ...
            try:
                ...
                for output_type_7_item_data in _output_type_7:
                    output_type_7_item = AgentStepOutputType7Item.from_dict(output_type_7_item_data)
            ...
            try:
                ...
                for output_type_8_item_data in _output_type_8:
                    output_type_8_item = AgentStepOutputType8Item.from_dict(output_type_8_item_data)
        ...
        def _parse_redacted_output(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                redacted_output_type_3 = AgentStepRedactedOutputType3.from_dict(data)
            ...
            try:
                ...
                for redacted_output_type_7_item_data in _redacted_output_type_7:
                    redacted_output_type_7_item = AgentStepRedactedOutputType7Item.from_dict(
            ...
            try:
                ...
                for redacted_output_type_8_item_data in _redacted_output_type_8:
                    redacted_output_type_8_item = AgentStepRedactedOutputType8Item.from_dict(
        ...
        metadata: AgentStepMetadata | Unset
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = AgentStepMetadata.from_dict(_metadata)
