...
from ..models.alert_name_filter_operator import AlertNameFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="AlertNameFilter")


@_attrs_define
class AlertNameFilter:
    """
    Attributes:
        operator (AlertNameFilterOperator):
        value (list[str] | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        operator = AlertNameFilterOperator(d.pop("operator"))
        ...
        alert_name_filter = cls(operator=operator, value=value, name=name, case_sensitive=case_sensitive)

        alert_name_filter.additional_properties = d
        return alert_name_filter
