...
class AnnotationQueueResponse:
    ...
    num_log_records: Unset | int = 0
    num_annotators: Unset | int = 0
    num_users: Unset | int = 0
    num_templates: Unset | int = 0
    ...
    overall_progress: None | Unset | float = UNSET
    templates: Unset | list["AnnotationTemplateDB"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        num_logs_annotated: None | Unset | dict[str, Any]
        ...
        progress: None | Unset | dict[str, Any]
        ...
        overall_progress = UNSET if isinstance(self.overall_progress, Unset) else self.overall_progress
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_num_logs_annotated(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return AnnotationQueueResponseNumLogsAnnotatedType0.from_dict(data)
        ...
        def _parse_progress(data: object) -> Union["AnnotationQueueResponseProgressType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return AnnotationQueueResponseProgressType0.from_dict(data)
        ...
        def _parse_overall_progress(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
