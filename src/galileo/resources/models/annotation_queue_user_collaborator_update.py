...
class AnnotationQueueUserCollaboratorUpdate:
    ...
    role: CollaboratorRole
    track_progress: None | Unset | bool = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        role = self.role.value

        track_progress: None | Unset | bool
        track_progress = UNSET if isinstance(self.track_progress, Unset) else self.track_progress
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_track_progress(data: object) -> None | Unset | bool:
            if data is None:
                return data
