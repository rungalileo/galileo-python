...
T = TypeVar("T", bound="AnnotationTraceSelector")


@_attrs_define
class AnnotationTraceSelector:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        annotation_trace_selector = cls(traces=traces, selector_type=selector_type)

        annotation_trace_selector.additional_properties = d
        return annotation_trace_selector
