...
T = TypeVar("T", bound="BodyCreateCodeScorerVersionV2ScorersScorerIdVersionCodePost")


@_attrs_define
class BodyCreateCodeScorerVersionV2ScorersScorerIdVersionCodePost:
    """
    Attributes:
        file (File):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_create_code_scorer_version_v2_scorers_scorer_id_version_code_post = cls(
            file=file, validation_result=validation_result
        )

        body_create_code_scorer_version_v2_scorers_scorer_id_version_code_post.additional_properties = d
        return body_create_code_scorer_version_v2_scorers_scorer_id_version_code_post
