...
T = TypeVar("T", bound="BodyCreateDatasetV2DatasetsPost")


@_attrs_define
class BodyCreateDatasetV2DatasetsPost:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_create_dataset_v2_datasets_post = cls(
            draft=draft,
            hidden=hidden,
            name=name,
        ...
        body_create_dataset_v2_datasets_post.additional_properties = d
        return body_create_dataset_v2_datasets_post
