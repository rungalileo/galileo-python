...
T = TypeVar("T", bound="BodyLoginEmailV1LoginPost")


@_attrs_define
class BodyLoginEmailV1LoginPost:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_login_email_v1_login_post = cls(
            username=username,
            password=password,
        ...
        body_login_email_v1_login_post.additional_properties = d
        return body_login_email_v1_login_post
