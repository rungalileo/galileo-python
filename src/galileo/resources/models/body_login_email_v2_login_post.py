...
T = TypeVar("T", bound="BodyLoginEmailV2LoginPost")


@_attrs_define
class BodyLoginEmailV2LoginPost:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_login_email_v2_login_post = cls(
            username=username,
            password=password,
        ...
        body_login_email_v2_login_post.additional_properties = d
        return body_login_email_v2_login_post
