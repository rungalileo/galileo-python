...
T = TypeVar("T", bound="BodyUpdatePromptDatasetV2ProjectsProjectIdPromptDatasetsDatasetIdPut")


@_attrs_define
class BodyUpdatePromptDatasetV2ProjectsProjectIdPromptDatasetsDatasetIdPut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_update_prompt_dataset_v2_projects_project_id_prompt_datasets_dataset_id_put = cls(
            file=file, column_names=column_names
        )

        body_update_prompt_dataset_v2_projects_project_id_prompt_datasets_dataset_id_put.additional_properties = d
        return body_update_prompt_dataset_v2_projects_project_id_prompt_datasets_dataset_id_put
