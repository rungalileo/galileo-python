...
T = TypeVar("T", bound="BodyValidateCodeScorerLogRecordPublicV2ScorersCodeValidateLogRecordPost")


@_attrs_define
class BodyValidateCodeScorerLogRecordPublicV2ScorersCodeValidateLogRecordPost:
    """
    Attributes:
        file (File):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_validate_code_scorer_log_record_public_v2_scorers_code_validate_log_record_post = cls(
            file=file,
        ...
        body_validate_code_scorer_log_record_public_v2_scorers_code_validate_log_record_post.additional_properties = d
        return body_validate_code_scorer_log_record_public_v2_scorers_code_validate_log_record_post
