...
T = TypeVar("T", bound="BodyValidateCodeScorerPublicV2ScorersCodeValidatePost")


@_attrs_define
class BodyValidateCodeScorerPublicV2ScorersCodeValidatePost:
    """
    Attributes:
        file (File):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_validate_code_scorer_public_v2_scorers_code_validate_post = cls(
            file=file,
        ...
        body_validate_code_scorer_public_v2_scorers_code_validate_post.additional_properties = d
        return body_validate_code_scorer_public_v2_scorers_code_validate_post
