...
from ..models.annotation_rating_operation_type import AnnotationRatingOperationType
from ..models.annotation_selector_type import AnnotationSelectorType
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkAnnotationRatingStatus")


@_attrs_define
class BulkAnnotationRatingStatus:
    """
    Attributes:
        operation (AnnotationRatingOperationType): Operation type for bulk annotation rating operations.
        success (bool):
        message (None | str):
        selector (AnnotationSelectorType | Unset):
        index (int | None | Unset):
        trace (None | str | Unset):
    """

    operation: AnnotationRatingOperationType
    success: bool
    message: None | str
    selector: AnnotationSelectorType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        operation = AnnotationRatingOperationType(d.pop("operation"))
        ...
        if isinstance(_selector, Unset):
            ...
            selector = AnnotationSelectorType(_selector)
        ...
        bulk_annotation_rating_status = cls(
            operation=operation, success=success, message=message, selector=selector, index=index, trace=trace
        )

        bulk_annotation_rating_status.additional_properties = d
        return bulk_annotation_rating_status
