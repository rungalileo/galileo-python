...
if TYPE_CHECKING:
    ...
    from ..models.trace_selector import TraceSelector
...
class BulkFeedbackRequest:
    """
    Attributes:
        operations (list[BulkFeedbackRatingCreate | BulkFeedbackRatingDelete]):
        selector (IndexSelector | TraceSelector):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for operations_item_data in _operations:
            ...
            def _parse_operations_item(data: object) -> BulkFeedbackRatingCreate | BulkFeedbackRatingDelete:
                try:
        ...
        def _parse_selector(data: object) -> IndexSelector | TraceSelector:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                selector_type_0 = IndexSelector.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            selector_type_1 = TraceSelector.from_dict(data)
