...
if TYPE_CHECKING:
    from ..models.cbo_run_cluster import CBORunCluster
    from ..models.filter_params import FilterParams


T = TypeVar("T", bound="CBOClusterResponse")


@_attrs_define
class CBOClusterResponse:
    """
    Attributes:
        cbo_clusters (list['CBORunCluster']):
    ...
    def to_dict(self) -> dict[str, Any]:
        cbo_clusters = []
        for cbo_clusters_item_data in self.cbo_clusters:
            cbo_clusters_item = cbo_clusters_item_data.to_dict()
            cbo_clusters.append(cbo_clusters_item)
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        cbo_clusters = []
        _cbo_clusters = d.pop("cbo_clusters")
        for cbo_clusters_item_data in _cbo_clusters:
            cbo_clusters_item = CBORunCluster.from_dict(cbo_clusters_item_data)
        ...
        cbo_cluster_response.additional_properties = d
        return cbo_cluster_response
