...
class ChainStep:
    """
    Attributes:
        input_ (Union['ChainStepInputType3', 'Document', 'Message', list['ChainStepInputType7Item'],
            list['ChainStepInputType8Item'], list['Document'], list['Message'], list[str], str]): Input to the step.
        ...
        metadata (Union[Unset, ChainStepMetadata]): Metadata associated with this step.
        name (Union[Unset, str]): Name of the step. Default: ''.
        output (Union['ChainStepOutputType3', 'Document', 'Message', Unset, list['ChainStepOutputType7Item'],
            list['ChainStepOutputType8Item'], list['Document'], list['Message'], list[str], str]): Output of the step.
            Default: ''.
        ...
        type_ (Union[Literal['chain'], Unset]): Type of the step. By default, it is set to chain. Default: 'chain'.
    """
    ...
    metadata: Union[Unset, "ChainStepMetadata"] = UNSET
    ...
    type_: Union[Literal["chain"], Unset] = "chain"
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, ChainStepMetadata]
        ...
        type_ = cast(Union[Literal["chain"], Unset], d.pop("type", UNSET))
