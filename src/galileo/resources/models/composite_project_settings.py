...
class CompositeProjectSettings:
    ...
    Attributes:
        ...
        metric_weights_configuration (CompositeProjectSettingsMetricWeightsConfigurationType0 | None | Unset):
    ...
    metric_weights_configuration: CompositeProjectSettingsMetricWeightsConfigurationType0 | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metric_weights_configuration(
            data: object,
        ) -> CompositeProjectSettingsMetricWeightsConfigurationType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(CompositeProjectSettingsMetricWeightsConfigurationType0 | None | Unset, data)
