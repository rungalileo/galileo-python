...
T = TypeVar("T", bound="ControlSpanRecordAnnotationAggregates")


@_attrs_define
class ControlSpanRecordAnnotationAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        control_span_record_annotation_aggregates = cls()
        ...
        control_span_record_annotation_aggregates.additional_properties = additional_properties
        return control_span_record_annotation_aggregates
