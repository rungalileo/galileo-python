...
T = TypeVar("T", bound="ControlSpanRecordFeedbackRatingInfo")


@_attrs_define
class ControlSpanRecordFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        control_span_record_feedback_rating_info = cls()
        ...
        control_span_record_feedback_rating_info.additional_properties = additional_properties
        return control_span_record_feedback_rating_info
