...
class CreateAnnotationQueueRequest:
    ...
    annotator_emails: Unset | list[str] = UNSET
    copy_templates_from_queue_id: None | Unset | str = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        copy_templates_from_queue_id: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_copy_templates_from_queue_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
