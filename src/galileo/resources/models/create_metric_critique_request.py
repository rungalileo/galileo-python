...
class CreateMetricCritiqueRequest:
    ...
    Attributes:
        ...
        id (None | str | Unset): The id of the metric critique if it's being updated. None if it's a new critique.
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({"run_id": run_id, "row_id": row_id, "critique": critique, "intended_value": intended_value})
        if id is not UNSET:
            field_dict["id"] = id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_row_id(data: object) -> int | UUID:
            try:
        ...
        create_metric_critique_request = cls(
            run_id=run_id, row_id=row_id, critique=critique, intended_value=intended_value, id=id
        )
