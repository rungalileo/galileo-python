...
T = TypeVar("T", bound="CreateMetricRollUpConfigRequest")


@_attrs_define
class CreateMetricRollUpConfigRequest:
    """Request to create a metric roll up configuration.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_metric_roll_up_config_request = cls(roll_up_methods=roll_up_methods)

        create_metric_roll_up_config_request.additional_properties = d
        return create_metric_roll_up_config_request
