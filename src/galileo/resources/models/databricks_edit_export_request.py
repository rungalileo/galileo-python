...
class DatabricksEditExportRequest:
    ...
    ----------
        ...
        col_mapping (Union['DatabricksEditExportRequestColMappingType0', None, Unset]):
    ...
    col_mapping: Union["DatabricksEditExportRequestColMappingType0", None, Unset] = UNSET
        ...
        def _parse_col_mapping(data: object) -> Union["DatabricksEditExportRequestColMappingType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return DatabricksEditExportRequestColMappingType0.from_dict(data)
