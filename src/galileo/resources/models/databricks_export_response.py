...
class DatabricksExportResponse:
    ...
    ----------
        ...
        col_mapping (Union['DatabricksExportResponseColMappingType0', None, Unset]):
    ...
    col_mapping: Union["DatabricksExportResponseColMappingType0", None, Unset] = UNSET
        ...
        def _parse_col_mapping(data: object) -> Union["DatabricksExportResponseColMappingType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return DatabricksExportResponseColMappingType0.from_dict(data)
