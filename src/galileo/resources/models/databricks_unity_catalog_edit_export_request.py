...
if TYPE_CHECKING:
    from ..models.databricks_unity_catalog_edit_export_request_col_mapping_type_0 import (
...
T = TypeVar("T", bound="DatabricksUnityCatalogEditExportRequest")


@_attrs_define
class DatabricksUnityCatalogEditExportRequest:
    """
    Attributes:
        catalog_name (str):
        edit_ids (list[str]):
        psl_content_file_name (str):
        schema_name (str):
        table_name (str):
        all_but (Union[Unset, bool]):  Default: False.
        col_mapping (Union['DatabricksUnityCatalogEditExportRequestColMappingType0', None, Unset]):  Default: None.
    ...
    col_mapping: Union["DatabricksUnityCatalogEditExportRequestColMappingType0", None, Unset] = None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        psl_content_file_name = self.psl_content_file_name
        ...
        if isinstance(self.col_mapping, Unset):
            col_mapping = UNSET
        elif isinstance(self.col_mapping, DatabricksUnityCatalogEditExportRequestColMappingType0):
        ...
        field_dict.update(
            {
                ...
                "edit_ids": edit_ids,
                "psl_content_file_name": psl_content_file_name,
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        psl_content_file_name = d.pop("psl_content_file_name")
        ...
        def _parse_col_mapping(
            data: object,
        ) -> Union["DatabricksUnityCatalogEditExportRequestColMappingType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                col_mapping_type_0 = DatabricksUnityCatalogEditExportRequestColMappingType0.from_dict(data)

                return col_mapping_type_0
            except:  # noqa: E722
                pass
            return cast(Union["DatabricksUnityCatalogEditExportRequestColMappingType0", None, Unset], data)
        ...
        databricks_unity_catalog_edit_export_request = cls(
            catalog_name=catalog_name,
            edit_ids=edit_ids,
            psl_content_file_name=psl_content_file_name,
            schema_name=schema_name,
        ...
        databricks_unity_catalog_edit_export_request.additional_properties = d
        return databricks_unity_catalog_edit_export_request
