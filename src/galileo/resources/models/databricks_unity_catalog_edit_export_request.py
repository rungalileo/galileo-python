...
class DatabricksUnityCatalogEditExportRequest:
    ...
    ----------
        ...
        col_mapping (Union['DatabricksUnityCatalogEditExportRequestColMappingType0', None, Unset]):
    ...
    col_mapping: Union["DatabricksUnityCatalogEditExportRequestColMappingType0", None, Unset] = UNSET
        ...
        def _parse_col_mapping(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return DatabricksUnityCatalogEditExportRequestColMappingType0.from_dict(data)
