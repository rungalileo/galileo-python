...
class DatabricksUnityCatalogExportEditsResponse:
    ...
    Attributes:
        ...
        col_mapping (Union['DatabricksUnityCatalogExportEditsResponseColMappingType0', None, Unset]):  Default: None.
    ...
    col_mapping: Union["DatabricksUnityCatalogExportEditsResponseColMappingType0", None, Unset] = None
        ...
        def _parse_col_mapping(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                col_mapping_type_0 = DatabricksUnityCatalogExportEditsResponseColMappingType0.from_dict(data)
