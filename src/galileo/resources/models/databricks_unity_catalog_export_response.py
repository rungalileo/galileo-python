...
if TYPE_CHECKING:
    from ..models.databricks_unity_catalog_export_response_col_mapping_type_0 import (
        DatabricksUnityCatalogExportResponseColMappingType0,
    )
    from ..models.filter_params import FilterParams


T = TypeVar("T", bound="DatabricksUnityCatalogExportResponse")


@_attrs_define
class DatabricksUnityCatalogExportResponse:
    """
    Attributes:
        results (list[Any]):
        all_but (Union[Unset, bool]):  Default: False.
        col_mapping (Union['DatabricksUnityCatalogExportResponseColMappingType0', None, Unset]):  Default: None.
    ...
    col_mapping: Union["DatabricksUnityCatalogExportResponseColMappingType0", None, Unset] = None
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_col_mapping(
            data: object,
        ) -> Union["DatabricksUnityCatalogExportResponseColMappingType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                col_mapping_type_0 = DatabricksUnityCatalogExportResponseColMappingType0.from_dict(data)

                return col_mapping_type_0
            except:  # noqa: E722
                pass
            return cast(Union["DatabricksUnityCatalogExportResponseColMappingType0", None, Unset], data)
        ...
        return databricks_unity_catalog_export_response
