...
if TYPE_CHECKING:
    from ..models.edit_get_response_edit_spans_type_0 import EditGetResponseEditSpansType0
    from ..models.edit_review_db import EditReviewDB
    from ..models.filter_params import FilterParams


T = TypeVar("T", bound="EditGetResponse")
...
class EditGetResponse:
    ...
    Attributes:
        ...
        edit_spans (Union['EditGetResponseEditSpansType0', None, Unset]):
        ...
        reviewers (Union[Unset, list['EditReviewDB']]):
    ...
    edit_spans: Union["EditGetResponseEditSpansType0", None, Unset] = UNSET
    ...
    reviewers: Union[Unset, list["EditReviewDB"]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.edit_spans, Unset):
            edit_spans = UNSET
        elif isinstance(self.edit_spans, EditGetResponseEditSpansType0):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_edit_spans(data: object) -> Union["EditGetResponseEditSpansType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                edit_spans_type_0 = EditGetResponseEditSpansType0.from_dict(data)

                return edit_spans_type_0
            except:  # noqa: E722
                pass
            return cast(Union["EditGetResponseEditSpansType0", None, Unset], data)
        ...
        for reviewers_item_data in _reviewers or []:
            reviewers_item = EditReviewDB.from_dict(reviewers_item_data)
        ...
        edit_get_response.additional_properties = d
        return edit_get_response
