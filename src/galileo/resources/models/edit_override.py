...
class EditOverride:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        map_threshold: Union[None, Unset, float]
        map_threshold = UNSET if isinstance(self.map_threshold, Unset) else self.map_threshold

        new_label: Union[None, Unset, str]
        new_label = UNSET if isinstance(self.new_label, Unset) else self.new_label

        note: Union[None, Unset, str]
        note = UNSET if isinstance(self.note, Unset) else self.note

        search_string: Union[None, Unset, str]
        search_string = UNSET if isinstance(self.search_string, Unset) else self.search_string
        ...
        text_replacement: Union[None, Unset, str]
        text_replacement = UNSET if isinstance(self.text_replacement, Unset) else self.text_replacement

        use_regex: Union[None, Unset, bool]
        use_regex = UNSET if isinstance(self.use_regex, Unset) else self.use_regex
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_edit_spans(data: object) -> Union["EditOverrideEditSpansType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return EditOverrideEditSpansType0.from_dict(data)
        ...
        def _parse_filter_(data: object) -> Union["FilterParams", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return FilterParams.from_dict(data)
