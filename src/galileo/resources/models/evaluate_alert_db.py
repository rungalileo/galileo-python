...
class EvaluateAlertDB:
    ...
    Attributes:
        ...
        run_id (str):
        alert_name (str):
        filter_ (CategoricalPromptFilterParam | RangePromptFilterParam | ValuePromptFilterParam):
        field_name (str):
        description (str):
        id (str):
        created_at (datetime.datetime):
        updated_at (datetime.datetime):
        extra (EvaluateAlertDBExtraType0 | None | Unset):
    """
    ...
    created_at: datetime.datetime
    updated_at: datetime.datetime
    extra: EvaluateAlertDBExtraType0 | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_extra(data: object) -> EvaluateAlertDBExtraType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(EvaluateAlertDBExtraType0 | None | Unset, data)
