...
if TYPE_CHECKING:
    ...
    from ..models.finetuned_scorer_config import FinetunedScorerConfig
...
class EvaluateRunRequest:
    """
    Attributes:
        workflows (list[AgentStep | ChainStep | LlmStep | RetrieverStep | ToolStep | WorkflowStep]): List of workflows
        ...
        scorers (list[AgenticSessionSuccessScorer | AgenticWorkflowSuccessScorer | BleuScorer |
            ...
            ToolSelectionQualityScorer | UncertaintyScorer] | Unset): List of Galileo scorers to enable.
        registered_scorers (list[RegisteredScorerConfig] | Unset): List of registered scorers to enable.
        generated_scorers (list[GeneratedScorerConfig] | Unset): List of generated scorers to enable.
        finetuned_scorers (list[FinetunedScorerConfig] | Unset): List of finetuned scorers to enable.
        project_id (None | str | Unset): Evaluate Project ID to which the run should be associated.
        project_name (None | str | Unset): Evaluate Project name to which the run should be associated. If the project
            does not exist, it will be created.
        run_name (None | str | Unset): Name of the run. If no name is provided, a timestamp-based name will be
            generated.
    """

    workflows: list[AgentStep | ChainStep | LlmStep | RetrieverStep | ToolStep | WorkflowStep]
    scorers: (
        list[
    ...
    registered_scorers: list[RegisteredScorerConfig] | Unset = UNSET
    generated_scorers: list[GeneratedScorerConfig] | Unset = UNSET
    finetuned_scorers: list[FinetunedScorerConfig] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        registered_scorers: list[dict[str, Any]] | Unset = UNSET
        ...
        generated_scorers: list[dict[str, Any]] | Unset = UNSET
        ...
        finetuned_scorers: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.finetuned_scorers, Unset):
            finetuned_scorers = []
            for finetuned_scorers_item_data in self.finetuned_scorers:
                finetuned_scorers_item = finetuned_scorers_item_data.to_dict()
                finetuned_scorers.append(finetuned_scorers_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        registered_scorers: list[RegisteredScorerConfig] | Unset = UNSET
        if _registered_scorers is not UNSET:
            registered_scorers = []
            for registered_scorers_item_data in _registered_scorers:
        ...
        generated_scorers: list[GeneratedScorerConfig] | Unset = UNSET
        if _generated_scorers is not UNSET:
            generated_scorers = []
            for generated_scorers_item_data in _generated_scorers:
                generated_scorers_item = GeneratedScorerConfig.from_dict(generated_scorers_item_data)

                generated_scorers.append(generated_scorers_item)

        _finetuned_scorers = d.pop("finetuned_scorers", UNSET)
        finetuned_scorers: list[FinetunedScorerConfig] | Unset = UNSET
        if _finetuned_scorers is not UNSET:
            finetuned_scorers = []
            for finetuned_scorers_item_data in _finetuned_scorers:
                finetuned_scorers_item = FinetunedScorerConfig.from_dict(finetuned_scorers_item_data)
