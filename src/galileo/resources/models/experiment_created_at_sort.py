...
T = TypeVar("T", bound="ExperimentCreatedAtSort")


@_attrs_define
class ExperimentCreatedAtSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        experiment_created_at_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        experiment_created_at_sort.additional_properties = d
        return experiment_created_at_sort
