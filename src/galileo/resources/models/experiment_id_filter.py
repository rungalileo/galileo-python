...
from ..models.experiment_id_filter_operator import ExperimentIDFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExperimentIDFilter")


@_attrs_define
class ExperimentIDFilter:
    """
    Attributes:
        value (Union[list[str], str]):
        name (Union[Literal['id'], Unset]):  Default: 'id'.
        operator (Union[Unset, ExperimentIDFilterOperator]):  Default: ExperimentIDFilterOperator.EQ.
    """

    value: Union[list[str], str]
    name: Union[Literal["id"], Unset] = "id"
    operator: Union[Unset, ExperimentIDFilterOperator] = ExperimentIDFilterOperator.EQ
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        operator: Union[Unset, ExperimentIDFilterOperator]
        if isinstance(_operator, Unset):
            operator = UNSET
        else:
            operator = ExperimentIDFilterOperator(_operator)

        experiment_id_filter = cls(value=value, name=name, operator=operator)

        experiment_id_filter.additional_properties = d
        return experiment_id_filter
