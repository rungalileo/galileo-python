...
from ..models.experiment_name_filter_operator import ExperimentNameFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExperimentNameFilter")


@_attrs_define
class ExperimentNameFilter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        operator = ExperimentNameFilterOperator(d.pop("operator"))
        ...
        experiment_name_filter = cls(operator=operator, value=value, name=name, case_sensitive=case_sensitive)

        experiment_name_filter.additional_properties = d
        return experiment_name_filter
