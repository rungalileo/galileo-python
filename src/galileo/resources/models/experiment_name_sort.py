...
T = TypeVar("T", bound="ExperimentNameSort")


@_attrs_define
class ExperimentNameSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        experiment_name_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        experiment_name_sort.additional_properties = d
        return experiment_name_sort
