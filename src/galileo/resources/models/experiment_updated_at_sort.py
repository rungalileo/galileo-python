...
T = TypeVar("T", bound="ExperimentUpdatedAtSort")


@_attrs_define
class ExperimentUpdatedAtSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        experiment_updated_at_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        experiment_updated_at_sort.additional_properties = d
        return experiment_updated_at_sort
