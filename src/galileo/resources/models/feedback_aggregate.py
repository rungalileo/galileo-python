...
class FeedbackAggregate:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(
            self.aggregate,
            LikeDislikeAggregate | StarAggregate | ScoreAggregate | TagsAggregate | (TextAggregate | ChoiceAggregate),
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_aggregate(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                return ChoiceAggregate.from_dict(data)

            except:  # noqa: E722
                pass
            if not isinstance(data, dict):
                raise TypeError()
            return TreeChoiceAggregate.from_dict(data)
