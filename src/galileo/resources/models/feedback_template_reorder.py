...
T = TypeVar("T", bound="FeedbackTemplateReorder")


@_attrs_define
class FeedbackTemplateReorder:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        feedback_template_reorder = cls(ordering=ordering)

        feedback_template_reorder.additional_properties = d
        return feedback_template_reorder
