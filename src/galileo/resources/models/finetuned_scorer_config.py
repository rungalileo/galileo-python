...
T = TypeVar("T", bound="FinetunedScorerConfig")


@_attrs_define
class FinetunedScorerConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        finetuned_scorer_config = cls(name=name, filters=filters)

        finetuned_scorer_config.additional_properties = d
        return finetuned_scorer_config
