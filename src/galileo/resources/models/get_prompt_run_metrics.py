...
class GetPromptRunMetrics:
    ...
    additional_properties: dict[str, FeedbackAggregate | float | int | None | str] = _attrs_field(
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            ...
            def _parse_additional_property(data: object) -> FeedbackAggregate | float | int | None | str:
                if data is None:
                    return data
                try:
                    ...
                    pass
                return cast(FeedbackAggregate | float | int | None | str, data)
    ...
    def __getitem__(self, key: str) -> FeedbackAggregate | float | int | None | str:
        return self.additional_properties[key]

    def __setitem__(self, key: str, value: FeedbackAggregate | float | int | None | str) -> None:
