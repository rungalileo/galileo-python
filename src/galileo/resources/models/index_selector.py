...
class IndexSelector:
    ...
    Attributes:
        indexes (list[int]):
        selector_type (Literal['indexes'] | Unset):  Default: 'indexes'.
    """

    indexes: list[int]
    selector_type: Literal["indexes"] | Unset = "indexes"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        selector_type = cast(Literal["indexes"] | Unset, d.pop("selector_type", UNSET))
