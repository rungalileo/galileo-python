...
class InferenceNamesResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({"project_id": project_id, "run_id": run_id, "inference_names": inference_names})
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inference_names_response = cls(project_id=project_id, run_id=run_id, inference_names=inference_names)
