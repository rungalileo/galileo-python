...
from ..models.insight_priority_category_type_0 import InsightPriorityCategoryType0
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.insight_example_occurrence import InsightExampleOccurrence
    from ..models.insight_occurrence import InsightOccurrence
...
class Insight:
    ...
    Attributes:
        ...
        all_occurrences (list[InsightOccurrence]):
        example_occurrences (list[InsightExampleOccurrence]):
        priority (int):
        priority_category (InsightPriorityCategoryType0 | None | Unset):
    ...
    example_occurrences: list[InsightExampleOccurrence]
    priority: int
    priority_category: InsightPriorityCategoryType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.priority_category, InsightPriorityCategoryType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for all_occurrences_item_data in _all_occurrences:
            all_occurrences_item = InsightOccurrence.from_dict(all_occurrences_item_data)
        ...
        for example_occurrences_item_data in _example_occurrences:
            example_occurrences_item = InsightExampleOccurrence.from_dict(example_occurrences_item_data)

            example_occurrences.append(example_occurrences_item)

        priority = d.pop("priority")

        def _parse_priority_category(data: object) -> InsightPriorityCategoryType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                priority_category_type_0 = InsightPriorityCategoryType0(data)

                return priority_category_type_0
            except:  # noqa: E722
                pass
            return cast(InsightPriorityCategoryType0 | None | Unset, data)
