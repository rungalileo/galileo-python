...
T = TypeVar("T", bound="InsightChartRequest")


@_attrs_define
class InsightChartRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        insight_chart_request.additional_properties = d
        return insight_chart_request
