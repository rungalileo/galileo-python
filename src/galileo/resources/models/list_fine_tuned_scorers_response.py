...
T = TypeVar("T", bound="ListFineTunedScorersResponse")


@_attrs_define
class ListFineTunedScorersResponse:
    """
    Attributes:
        scorers (list[FineTunedScorerResponse]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for scorers_item_data in _scorers:
            scorers_item = FineTunedScorerResponse.from_dict(scorers_item_data)
        ...
        list_fine_tuned_scorers_response = cls(
            scorers=scorers,
        ...
        list_fine_tuned_scorers_response.additional_properties = d
        return list_fine_tuned_scorers_response
