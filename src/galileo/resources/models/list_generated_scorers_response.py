...
T = TypeVar("T", bound="ListGeneratedScorersResponse")


@_attrs_define
class ListGeneratedScorersResponse:
    """
    Attributes:
        scorers (list['GeneratedScorerResponse']):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for scorers_item_data in _scorers:
            scorers_item = GeneratedScorerResponse.from_dict(scorers_item_data)
        ...
        list_generated_scorers_response = cls(
            scorers=scorers,
            limit=limit,
        ...
        list_generated_scorers_response.additional_properties = d
        return list_generated_scorers_response
