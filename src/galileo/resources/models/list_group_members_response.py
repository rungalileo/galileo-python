...
T = TypeVar("T", bound="ListGroupMembersResponse")
...
class ListGroupMembersResponse:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for members_item_data in _members:
            members_item = GroupMemberDB.from_dict(members_item_data)
        ...
        list_group_members_response = cls(
            members=members,
            limit=limit,
        ...
        list_group_members_response.additional_properties = d
