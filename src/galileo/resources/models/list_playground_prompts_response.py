...
T = TypeVar("T", bound="ListPlaygroundPromptsResponse")


@_attrs_define
class ListPlaygroundPromptsResponse:
    """
    Attributes:
        prompts (list[PlaygroundPromptResponse]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({"prompts": prompts})
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for prompts_item_data in _prompts:
            prompts_item = PlaygroundPromptResponse.from_dict(prompts_item_data)
        ...
        list_playground_prompts_response = cls(
            prompts=prompts,
        ...
        list_playground_prompts_response.additional_properties = d
        return list_playground_prompts_response
