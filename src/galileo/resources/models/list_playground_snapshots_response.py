...
if TYPE_CHECKING:
    from ..models.playground_snapshot_response import PlaygroundSnapshotResponse


T = TypeVar("T", bound="ListPlaygroundSnapshotsResponse")


@_attrs_define
class ListPlaygroundSnapshotsResponse:
    """
    Attributes:
        snapshots (list[PlaygroundSnapshotResponse]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({"snapshots": snapshots})
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for snapshots_item_data in _snapshots:
            snapshots_item = PlaygroundSnapshotResponse.from_dict(snapshots_item_data)
        ...
        list_playground_snapshots_response = cls(
            snapshots=snapshots,
        ...
        list_playground_snapshots_response.additional_properties = d
        return list_playground_snapshots_response
