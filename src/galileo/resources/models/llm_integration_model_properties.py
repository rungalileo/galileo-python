...
T = TypeVar("T", bound="LLMIntegrationModelProperties")


@_attrs_define
class LLMIntegrationModelProperties:
    """
    Attributes:
        alias (str):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        llm_integration_model_properties = cls(
            alias=alias, name=name, input_modalities=input_modalities, multimodal_capabilities=multimodal_capabilities
        )

        llm_integration_model_properties.additional_properties = d
        return llm_integration_model_properties
