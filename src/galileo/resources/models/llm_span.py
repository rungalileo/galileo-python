...
if TYPE_CHECKING:
    ...
    from ..models.llm_span_input_type_3 import LlmSpanInputType3
    from ..models.llm_span_input_type_7_item import LlmSpanInputType7Item
    from ..models.llm_span_input_type_8_item import LlmSpanInputType8Item
    from ..models.llm_span_metadata import LlmSpanMetadata
    from ..models.llm_span_output_type_3 import LlmSpanOutputType3
    from ..models.llm_span_output_type_7_item import LlmSpanOutputType7Item
    from ..models.llm_span_output_type_8_item import LlmSpanOutputType8Item
...
class LlmSpan:
    """
    Attributes:
        input_ (Union['Document', 'LlmSpanInputType3', 'Message', list['Document'], list['LlmSpanInputType7Item'],
            list['LlmSpanInputType8Item'], list['Message'], list[str], str]): Input to the step.
        ...
        metadata (Union[Unset, LlmSpanMetadata]): Metadata associated with this step.
        model (Union[None, Unset, str]): Model used for this step.
        name (Union[Unset, str]): Name of the step. Default: ''.
        output (Union['Document', 'LlmSpanOutputType3', 'Message', Unset, list['Document'],
            list['LlmSpanOutputType7Item'], list['LlmSpanOutputType8Item'], list['Message'], list[str], str]): Output of the
            step. Default: ''.
    ...
    input_: Union[
        ...
        "Message",
        list["Document"],
        list["LlmSpanInputType7Item"],
        list["LlmSpanInputType8Item"],
        list["Message"],
        list[str],
        str,
    ]
    ...
    metadata: Union[Unset, "LlmSpanMetadata"] = UNSET
    ...
    output: Union[
        ...
        Unset,
        list["Document"],
        list["LlmSpanOutputType7Item"],
        list["LlmSpanOutputType8Item"],
        list["Message"],
        list[str],
        str,
    ] = ""
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.input_, Document):
            ...
            input_ = self.input_.to_dict()
        elif isinstance(self.input_, LlmSpanInputType3):
            input_ = self.input_.to_dict()
        ...
        if isinstance(self.output, Unset):
            ...
            output = self.output.to_dict()
        elif isinstance(self.output, LlmSpanOutputType3):
            output = self.output.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_input_(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                input_type_3 = LlmSpanInputType3.from_dict(data)
            ...
            try:
                ...
                for input_type_7_item_data in _input_type_7:
                    input_type_7_item = LlmSpanInputType7Item.from_dict(input_type_7_item_data)
            ...
            try:
                ...
                for input_type_8_item_data in _input_type_8:
                    input_type_8_item = LlmSpanInputType8Item.from_dict(input_type_8_item_data)
        ...
        metadata: Union[Unset, LlmSpanMetadata]
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = LlmSpanMetadata.from_dict(_metadata)
        ...
        def _parse_output(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                output_type_3 = LlmSpanOutputType3.from_dict(data)
            ...
            try:
                ...
                for output_type_7_item_data in _output_type_7:
                    output_type_7_item = LlmSpanOutputType7Item.from_dict(output_type_7_item_data)
            ...
            try:
                ...
                for output_type_8_item_data in _output_type_8:
                    output_type_8_item = LlmSpanOutputType8Item.from_dict(output_type_8_item_data)
