...
if TYPE_CHECKING:
    ...
    from ..models.llm_span_record_annotation_aggregates import LlmSpanRecordAnnotationAggregates
    from ..models.llm_span_record_annotations import LlmSpanRecordAnnotations
    from ..models.llm_span_record_dataset_metadata import LlmSpanRecordDatasetMetadata
    from ..models.llm_span_record_feedback_rating_info import LlmSpanRecordFeedbackRatingInfo
...
class LlmSpanRecord:
    ...
    Attributes:
        ...
        user_metadata (LlmSpanRecordUserMetadata | Unset): Metadata associated with this trace or span.
        ...
        dataset_metadata (LlmSpanRecordDatasetMetadata | Unset): Metadata from the dataset associated with this trace
        ...
        feedback_rating_info (LlmSpanRecordFeedbackRatingInfo | Unset): Feedback information related to the record
        annotations (LlmSpanRecordAnnotations | Unset): Annotations keyed by template ID and annotator ID
        ...
        annotation_aggregates (LlmSpanRecordAnnotationAggregates | Unset): Annotation aggregate information keyed by
            template ID
        ...
        tools (list[LlmSpanRecordToolsType0Item] | None | Unset): List of available tools passed to the LLM on
            invocation.
    ...
    user_metadata: LlmSpanRecordUserMetadata | Unset = UNSET
    ...
    dataset_metadata: LlmSpanRecordDatasetMetadata | Unset = UNSET
    ...
    feedback_rating_info: LlmSpanRecordFeedbackRatingInfo | Unset = UNSET
    annotations: LlmSpanRecordAnnotations | Unset = UNSET
    file_ids: list[str] | Unset = UNSET
    file_modalities: list[ContentModality] | Unset = UNSET
    annotation_aggregates: LlmSpanRecordAnnotationAggregates | Unset = UNSET
    annotation_queue_ids: list[str] | Unset = UNSET
    is_complete: bool | Unset = True
    step_number: int | None | Unset = UNSET
    tools: list[LlmSpanRecordToolsType0Item] | None | Unset = UNSET
    events: (
        list[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_metadata: LlmSpanRecordUserMetadata | Unset
        ...
        dataset_metadata: LlmSpanRecordDatasetMetadata | Unset
        ...
        feedback_rating_info: LlmSpanRecordFeedbackRatingInfo | Unset
        if isinstance(_feedback_rating_info, Unset):
            feedback_rating_info = UNSET
        else:
            feedback_rating_info = LlmSpanRecordFeedbackRatingInfo.from_dict(_feedback_rating_info)

        _annotations = d.pop("annotations", UNSET)
        annotations: LlmSpanRecordAnnotations | Unset
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = LlmSpanRecordAnnotations.from_dict(_annotations)
        ...
        annotation_aggregates: LlmSpanRecordAnnotationAggregates | Unset
        if isinstance(_annotation_aggregates, Unset):
            annotation_aggregates = UNSET
        else:
            annotation_aggregates = LlmSpanRecordAnnotationAggregates.from_dict(_annotation_aggregates)
        ...
        def _parse_tools(data: object) -> list[LlmSpanRecordToolsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[LlmSpanRecordToolsType0Item] | None | Unset, data)
