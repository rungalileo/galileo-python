...
T = TypeVar("T", bound="LlmSpanRecordAnnotationAggregates")


@_attrs_define
class LlmSpanRecordAnnotationAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        llm_span_record_annotation_aggregates = cls()
        ...
        llm_span_record_annotation_aggregates.additional_properties = additional_properties
        return llm_span_record_annotation_aggregates
