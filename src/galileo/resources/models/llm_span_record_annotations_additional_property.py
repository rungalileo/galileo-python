...
T = TypeVar("T", bound="LlmSpanRecordAnnotationsAdditionalProperty")


@_attrs_define
class LlmSpanRecordAnnotationsAdditionalProperty:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        llm_span_record_annotations_additional_property = cls()
        ...
        llm_span_record_annotations_additional_property.additional_properties = additional_properties
        return llm_span_record_annotations_additional_property
