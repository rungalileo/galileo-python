...
T = TypeVar("T", bound="LlmSpanRecordFeedbackRatingInfo")


@_attrs_define
class LlmSpanRecordFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        llm_span_record_feedback_rating_info = cls()
        ...
        llm_span_record_feedback_rating_info.additional_properties = additional_properties
        return llm_span_record_feedback_rating_info
