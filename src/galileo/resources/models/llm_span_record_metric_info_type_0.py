...
T = TypeVar("T", bound="LlmSpanRecordMetricInfoType0")


@_attrs_define
class LlmSpanRecordMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        llm_span_record_metric_info_type_0 = cls()
        ...
        llm_span_record_metric_info_type_0.additional_properties = additional_properties
        return llm_span_record_metric_info_type_0
