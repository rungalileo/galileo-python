...
T = TypeVar("T", bound="LogRecordsChoiceRating")


@_attrs_define
class LogRecordsChoiceRating:
    """
    Attributes:
        value (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        log_records_choice_rating = cls(value=value, feedback_type=feedback_type)

        log_records_choice_rating.additional_properties = d
        return log_records_choice_rating
