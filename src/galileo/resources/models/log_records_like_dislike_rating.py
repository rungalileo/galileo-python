...
T = TypeVar("T", bound="LogRecordsLikeDislikeRating")


@_attrs_define
class LogRecordsLikeDislikeRating:
    """
    Attributes:
        value (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        log_records_like_dislike_rating = cls(value=value, feedback_type=feedback_type)

        log_records_like_dislike_rating.additional_properties = d
        return log_records_like_dislike_rating
