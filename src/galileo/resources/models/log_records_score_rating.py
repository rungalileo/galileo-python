...
T = TypeVar("T", bound="LogRecordsScoreRating")


@_attrs_define
class LogRecordsScoreRating:
    """
    Attributes:
        value (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        log_records_score_rating = cls(value=value, feedback_type=feedback_type)

        log_records_score_rating.additional_properties = d
        return log_records_score_rating
