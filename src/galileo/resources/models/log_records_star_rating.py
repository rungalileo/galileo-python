...
T = TypeVar("T", bound="LogRecordsStarRating")


@_attrs_define
class LogRecordsStarRating:
    """
    Attributes:
        value (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        log_records_star_rating = cls(value=value, feedback_type=feedback_type)

        log_records_star_rating.additional_properties = d
        return log_records_star_rating
