...
T = TypeVar("T", bound="LogRecordsTagsRating")


@_attrs_define
class LogRecordsTagsRating:
    """
    Attributes:
        value (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        log_records_tags_rating = cls(value=value, feedback_type=feedback_type)

        log_records_tags_rating.additional_properties = d
        return log_records_tags_rating
