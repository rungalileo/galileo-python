...
T = TypeVar("T", bound="LogRecordsTextRating")


@_attrs_define
class LogRecordsTextRating:
    """
    Attributes:
        value (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        log_records_text_rating = cls(value=value, feedback_type=feedback_type)

        log_records_text_rating.additional_properties = d
        return log_records_text_rating
