...
T = TypeVar("T", bound="LogRecordsTreeChoiceRating")


@_attrs_define
class LogRecordsTreeChoiceRating:
    """
    Attributes:
        value (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        log_records_tree_choice_rating = cls(value=value, feedback_type=feedback_type)

        log_records_tree_choice_rating.additional_properties = d
        return log_records_tree_choice_rating
