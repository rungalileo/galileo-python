...
from ..models.log_stream_created_by_filter_operator import LogStreamCreatedByFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="LogStreamCreatedByFilter")


@_attrs_define
class LogStreamCreatedByFilter:
    """
    Attributes:
        value (Union[list[str], str]):
        name (Union[Literal['created_by'], Unset]):  Default: 'created_by'.
        operator (Union[Unset, LogStreamCreatedByFilterOperator]):  Default: LogStreamCreatedByFilterOperator.EQ.
    """

    value: Union[list[str], str]
    name: Union[Literal["created_by"], Unset] = "created_by"
    operator: Union[Unset, LogStreamCreatedByFilterOperator] = LogStreamCreatedByFilterOperator.EQ
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        operator: Union[Unset, LogStreamCreatedByFilterOperator]
        if isinstance(_operator, Unset):
            operator = UNSET
        else:
            operator = LogStreamCreatedByFilterOperator(_operator)

        log_stream_created_by_filter = cls(value=value, name=name, operator=operator)

        log_stream_created_by_filter.additional_properties = d
        return log_stream_created_by_filter
