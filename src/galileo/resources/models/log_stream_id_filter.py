...
from ..models.log_stream_id_filter_operator import LogStreamIDFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="LogStreamIDFilter")


@_attrs_define
class LogStreamIDFilter:
    """
    Attributes:
        value (Union[list[str], str]):
        name (Union[Literal['id'], Unset]):  Default: 'id'.
        operator (Union[Unset, LogStreamIDFilterOperator]):  Default: LogStreamIDFilterOperator.EQ.
    """

    value: Union[list[str], str]
    name: Union[Literal["id"], Unset] = "id"
    operator: Union[Unset, LogStreamIDFilterOperator] = LogStreamIDFilterOperator.EQ
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        operator: Union[Unset, LogStreamIDFilterOperator]
        if isinstance(_operator, Unset):
            operator = UNSET
        else:
            operator = LogStreamIDFilterOperator(_operator)

        log_stream_id_filter = cls(value=value, name=name, operator=operator)

        log_stream_id_filter.additional_properties = d
        return log_stream_id_filter
