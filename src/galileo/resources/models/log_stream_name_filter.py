...
from ..models.log_stream_name_filter_operator import LogStreamNameFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="LogStreamNameFilter")


@_attrs_define
class LogStreamNameFilter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        operator = LogStreamNameFilterOperator(d.pop("operator"))
        ...
        log_stream_name_filter = cls(operator=operator, value=value, name=name, case_sensitive=case_sensitive)

        log_stream_name_filter.additional_properties = d
        return log_stream_name_filter
