...
T = TypeVar("T", bound="LogStreamNameSort")


@_attrs_define
class LogStreamNameSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        log_stream_name_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        log_stream_name_sort.additional_properties = d
        return log_stream_name_sort
