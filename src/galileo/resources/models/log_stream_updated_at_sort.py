...
T = TypeVar("T", bound="LogStreamUpdatedAtSort")


@_attrs_define
class LogStreamUpdatedAtSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        log_stream_updated_at_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        log_stream_updated_at_sort.additional_properties = d
        return log_stream_updated_at_sort
