...
T = TypeVar("T", bound="LogstreamInsightTokenUsageCreatedAtSort")


@_attrs_define
class LogstreamInsightTokenUsageCreatedAtSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        logstream_insight_token_usage_created_at_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        logstream_insight_token_usage_created_at_sort.additional_properties = d
        return logstream_insight_token_usage_created_at_sort
