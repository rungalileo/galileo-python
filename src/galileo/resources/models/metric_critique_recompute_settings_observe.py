...
T = TypeVar("T", bound="MetricCritiqueRecomputeSettingsObserve")


@_attrs_define
class MetricCritiqueRecomputeSettingsObserve:
    """
    Attributes:
        mode (Literal['observe_filters'] | Unset):  Default: 'observe_filters'.
        filters (list[QueryFilterV1] | Unset): The parsed filters that are used to recompute the metric critique.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metric_critique_recompute_settings_observe = cls(mode=mode, filters=filters)

        metric_critique_recompute_settings_observe.additional_properties = d
        return metric_critique_recompute_settings_observe
