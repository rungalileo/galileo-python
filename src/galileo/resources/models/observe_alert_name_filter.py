...
from ..models.observe_alert_name_filter_operator import ObserveAlertNameFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="ObserveAlertNameFilter")


@_attrs_define
class ObserveAlertNameFilter:
    """
    Attributes:
        operator (ObserveAlertNameFilterOperator):
        value (list[str] | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        operator = ObserveAlertNameFilterOperator(d.pop("operator"))
        ...
        observe_alert_name_filter = cls(operator=operator, value=value, name=name, case_sensitive=case_sensitive)

        observe_alert_name_filter.additional_properties = d
        return observe_alert_name_filter
