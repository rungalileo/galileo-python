...
from ..models.organization_name_filter_operator import OrganizationNameFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="OrganizationNameFilter")


@_attrs_define
class OrganizationNameFilter:
    """
    Attributes:
        operator (OrganizationNameFilterOperator):
        value (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        d = src_dict.copy()
        operator = OrganizationNameFilterOperator(d.pop("operator"))
        ...
        organization_name_filter = cls(operator=operator, value=value, case_sensitive=case_sensitive, name=name)

        organization_name_filter.additional_properties = d
        return organization_name_filter
