...
from ..models.output_sexist_scorer_type import OutputSexistScorerType, check_output_sexist_scorer_type
...
class OutputSexistScorer:
    ...
    Attributes:
        ...
        type_ (Union[Unset, OutputSexistScorerType]):  Default: 'luna'.
    """
    ...
    type_: Union[Unset, OutputSexistScorerType] = "luna"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = check_output_sexist_scorer_type(_type_)
