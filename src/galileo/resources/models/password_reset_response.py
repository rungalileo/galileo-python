...
class PasswordResetResponse:
    """
    Attributes:
        pathname (None | str | Unset):
    """

    pathname: None | str | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        pathname: None | str | Unset
        if isinstance(self.pathname, Unset):
            pathname = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_pathname(data: object) -> None | str | Unset:
            if data is None:
                return data
        ...
        pathname = _parse_pathname(d.pop("pathname", UNSET))
