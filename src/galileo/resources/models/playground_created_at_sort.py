...
T = TypeVar("T", bound="PlaygroundCreatedAtSort")


@_attrs_define
class PlaygroundCreatedAtSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        playground_created_at_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        playground_created_at_sort.additional_properties = d
        return playground_created_at_sort
