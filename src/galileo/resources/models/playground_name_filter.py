...
from ..models.playground_name_filter_operator import PlaygroundNameFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="PlaygroundNameFilter")


@_attrs_define
class PlaygroundNameFilter:
    """
    Attributes:
        operator (PlaygroundNameFilterOperator):
        value (list[str] | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        operator = PlaygroundNameFilterOperator(d.pop("operator"))
        ...
        playground_name_filter = cls(operator=operator, value=value, name=name, case_sensitive=case_sensitive)

        playground_name_filter.additional_properties = d
        return playground_name_filter
