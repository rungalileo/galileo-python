...
T = TypeVar("T", bound="PlaygroundNameSort")


@_attrs_define
class PlaygroundNameSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        playground_name_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        playground_name_sort.additional_properties = d
        return playground_name_sort
