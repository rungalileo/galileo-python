...
T = TypeVar("T", bound="PlaygroundSnapshotCreatedAtSort")


@_attrs_define
class PlaygroundSnapshotCreatedAtSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        playground_snapshot_created_at_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        playground_snapshot_created_at_sort.additional_properties = d
        return playground_snapshot_created_at_sort
