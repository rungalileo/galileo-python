...
T = TypeVar("T", bound="PlaygroundUpdatedAtSort")


@_attrs_define
class PlaygroundUpdatedAtSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        playground_updated_at_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        playground_updated_at_sort.additional_properties = d
        return playground_updated_at_sort
