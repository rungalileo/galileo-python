...
T = TypeVar("T", bound="ProjectBookmarkFilterV2")


@_attrs_define
class ProjectBookmarkFilterV2:
    """
    Attributes:
        value (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_bookmark_filter_v2 = cls(value=value, name=name)

        project_bookmark_filter_v2.additional_properties = d
        return project_bookmark_filter_v2
