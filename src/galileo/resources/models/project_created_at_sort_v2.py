...
T = TypeVar("T", bound="ProjectCreatedAtSortV2")


@_attrs_define
class ProjectCreatedAtSortV2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_created_at_sort_v2 = cls(name=name, ascending=ascending, sort_type=sort_type)

        project_created_at_sort_v2.additional_properties = d
        return project_created_at_sort_v2
