...
from ..models.project_name_filter_v2_operator import ProjectNameFilterV2Operator
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectNameFilterV2")


@_attrs_define
class ProjectNameFilterV2:
    """
    Attributes:
        operator (ProjectNameFilterV2Operator):
        value (list[str] | str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        operator = ProjectNameFilterV2Operator(d.pop("operator"))
        ...
        project_name_filter_v2 = cls(operator=operator, value=value, name=name, case_sensitive=case_sensitive)

        project_name_filter_v2.additional_properties = d
        return project_name_filter_v2
