...
T = TypeVar("T", bound="ProjectNameSortV2")


@_attrs_define
class ProjectNameSortV2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_name_sort_v2 = cls(name=name, ascending=ascending, sort_type=sort_type)

        project_name_sort_v2.additional_properties = d
        return project_name_sort_v2
