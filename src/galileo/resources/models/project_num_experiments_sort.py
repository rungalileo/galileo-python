...
T = TypeVar("T", bound="ProjectNumExperimentsSort")


@_attrs_define
class ProjectNumExperimentsSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_num_experiments_sort = cls(name=name, ascending=ascending, sort_type=sort_type)
