...
from ..models.project_updated_at_filter_operator import (
    ProjectUpdatedAtFilterOperator,
    check_project_updated_at_filter_operator,
)
...
class ProjectUpdatedAtFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        operator = check_project_updated_at_filter_operator(d.pop("operator"))
