...
T = TypeVar("T", bound="ProjectUpdatedAtSortV2")


@_attrs_define
class ProjectUpdatedAtSortV2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_updated_at_sort_v2 = cls(name=name, ascending=ascending, sort_type=sort_type)

        project_updated_at_sort_v2.additional_properties = d
        return project_updated_at_sort_v2
