...
class PromptChainIngestBatchRequest:
    ...
    Attributes:
        ...
        timeout_minutes (Union[Unset, int]): Minutes to wait before concluding ingestion, regardless of how many batches
            of chains / chains have been successfully ingested.
    """
