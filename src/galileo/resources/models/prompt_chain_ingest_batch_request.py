...
T = TypeVar("T", bound="PromptChainIngestBatchRequest")


@_attrs_define
class PromptChainIngestBatchRequest:
    """
    Attributes:
        total_chains (int): Total number of chains / workflows in the batch. This should match the unique root ID count
            and is used to determine if all chains have been ingested.
        rows (list[ChainRow] | Unset):
        scorers (list[AgenticSessionSuccessScorer | AgenticWorkflowSuccessScorer | BleuScorer |
            ...
            ToolSelectionQualityScorer | UncertaintyScorer] | Unset):
        prompt_registered_scorers_configuration (list[RegisteredScorer] | None | Unset):
        generated_scorers (list[GeneratedScorerConfig] | None | Unset):
        finetuned_scorers (list[FineTunedScorer] | None | Unset):
        ...
        prompt_customized_scorers_configuration (list[CustomizedAgenticSessionSuccessGPTScorer |
            ...
            | Unset):
        timeout_minutes (int | Unset): Minutes to wait before concluding ingestion, regardless of how many batches of
            chains / chains have been successfully ingested.
    """

    total_chains: int
    rows: list[ChainRow] | Unset = UNSET
    scorers: (
        list[
    ...
    generated_scorers: list[GeneratedScorerConfig] | None | Unset = UNSET
    finetuned_scorers: list[FineTunedScorer] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.scorers, Unset):
            ...
            for scorers_item_data in self.scorers:
                ...
                elif isinstance(scorers_item_data, AgenticSessionSuccessScorer):
                    scorers_item = scorers_item_data.to_dict()
        ...
        generated_scorers: list[dict[str, Any]] | None | Unset
        ...
        finetuned_scorers: list[dict[str, Any]] | None | Unset
        if isinstance(self.finetuned_scorers, Unset):
            finetuned_scorers = UNSET
        elif isinstance(self.finetuned_scorers, list):
            finetuned_scorers = []
            for finetuned_scorers_type_0_item_data in self.finetuned_scorers:
                finetuned_scorers_type_0_item = finetuned_scorers_type_0_item_data.to_dict()
                finetuned_scorers.append(finetuned_scorers_type_0_item)

        else:
            finetuned_scorers = self.finetuned_scorers
        ...
        if finetuned_scorers is not UNSET:
            field_dict["finetuned_scorers"] = finetuned_scorers
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
            ...
            for scorers_item_data in _scorers:
                ...
                def _parse_scorers_item(
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_1 = AgenticSessionSuccessScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_2 = BleuScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_3 = ChunkAttributionUtilizationScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_4 = CompletenessScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_5 = ContextAdherenceScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_6 = ContextRelevanceScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_7 = CorrectnessScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_8 = GroundTruthAdherenceScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_9 = InputPIIScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_10 = InputSexistScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_11 = InputToneScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_12 = InputToxicityScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_13 = InstructionAdherenceScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_14 = OutputPIIScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_15 = OutputSexistScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_16 = OutputToneScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_17 = OutputToxicityScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_18 = PromptInjectionScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_19 = PromptPerplexityScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_20 = RougeScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_21 = ToolErrorRateScorer.from_dict(data)
                    ...
                    try:
                        if not isinstance(data, dict):
                            raise TypeError()
                        scorers_item_type_22 = ToolSelectionQualityScorer.from_dict(data)
                    ...
                    if not isinstance(data, dict):
                        raise TypeError()
                    scorers_item_type_23 = UncertaintyScorer.from_dict(data)

                    return scorers_item_type_23
        ...
        def _parse_generated_scorers(data: object) -> list[GeneratedScorerConfig] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_finetuned_scorers(data: object) -> list[FineTunedScorer] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, list):
                    raise TypeError()
                finetuned_scorers_type_0 = []
                _finetuned_scorers_type_0 = data
                for finetuned_scorers_type_0_item_data in _finetuned_scorers_type_0:
                    finetuned_scorers_type_0_item = FineTunedScorer.from_dict(finetuned_scorers_type_0_item_data)

                    finetuned_scorers_type_0.append(finetuned_scorers_type_0_item)

                return finetuned_scorers_type_0
            except:  # noqa: E722
                pass
            return cast(list[FineTunedScorer] | None | Unset, data)

        finetuned_scorers = _parse_finetuned_scorers(d.pop("finetuned_scorers", UNSET))
        ...
        prompt_chain_ingest_batch_request.additional_properties = d
        return prompt_chain_ingest_batch_request
