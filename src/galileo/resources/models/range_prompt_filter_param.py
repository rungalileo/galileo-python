...
class RangePromptFilterParam:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({"column": column, "filter_type": filter_type, "low": low, "high": high})
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        range_prompt_filter_param = cls(column=column, filter_type=filter_type, low=low, high=high)
