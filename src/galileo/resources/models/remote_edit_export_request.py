...
if TYPE_CHECKING:
    ...
    from ..models.remote_edit_export_request_col_mapping_type_0 import RemoteEditExportRequestColMappingType0


T = TypeVar("T", bound="RemoteEditExportRequest")


@_attrs_define
class RemoteEditExportRequest:
    """
    Attributes:
        bucket_name (str):
        edit_ids (list[str]):
        ...
        col_mapping (Union['RemoteEditExportRequestColMappingType0', None, Unset]):  Default: None.
    ...
    col_mapping: Union["RemoteEditExportRequestColMappingType0", None, Unset] = None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.col_mapping, Unset):
            col_mapping = UNSET
        elif isinstance(self.col_mapping, RemoteEditExportRequestColMappingType0):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_col_mapping(data: object) -> Union["RemoteEditExportRequestColMappingType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                col_mapping_type_0 = RemoteEditExportRequestColMappingType0.from_dict(data)

                return col_mapping_type_0
            except:  # noqa: E722
                pass
            return cast(Union["RemoteEditExportRequestColMappingType0", None, Unset], data)
        ...
        remote_edit_export_request = cls(
        ...
        remote_edit_export_request.additional_properties = d
        return remote_edit_export_request
