...
if TYPE_CHECKING:
    ...
    from ..models.remote_edit_export_response_col_mapping_type_0 import RemoteEditExportResponseColMappingType0


T = TypeVar("T", bound="RemoteEditExportResponse")


@_attrs_define
class RemoteEditExportResponse:
    """
    Attributes:
        bucket_name (str):
        edit_ids (list[str]):
        ...
        col_mapping (Union['RemoteEditExportResponseColMappingType0', None, Unset]):  Default: None.
    ...
    col_mapping: Union["RemoteEditExportResponseColMappingType0", None, Unset] = None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.col_mapping, Unset):
            col_mapping = UNSET
        elif isinstance(self.col_mapping, RemoteEditExportResponseColMappingType0):
        ...
        field_dict.update({"bucket_name": bucket_name, "edit_ids": edit_ids, "object_name": object_name})
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_col_mapping(data: object) -> Union["RemoteEditExportResponseColMappingType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                col_mapping_type_0 = RemoteEditExportResponseColMappingType0.from_dict(data)

                return col_mapping_type_0
            except:  # noqa: E722
                pass
            return cast(Union["RemoteEditExportResponseColMappingType0", None, Unset], data)
        ...
        remote_edit_export_response = cls(
        ...
        remote_edit_export_response.additional_properties = d
        return remote_edit_export_response
