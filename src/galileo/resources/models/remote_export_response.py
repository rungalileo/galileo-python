...
if TYPE_CHECKING:
    ...
    from ..models.remote_export_response_col_mapping_type_0 import RemoteExportResponseColMappingType0


T = TypeVar("T", bound="RemoteExportResponse")
...
class RemoteExportResponse:
    ...
    Attributes:
        ...
        col_mapping (Union['RemoteExportResponseColMappingType0', None, Unset]):  Default: None.
    ...
    col_mapping: Union["RemoteExportResponseColMappingType0", None, Unset] = None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.col_mapping, Unset):
            col_mapping = UNSET
        elif isinstance(self.col_mapping, RemoteExportResponseColMappingType0):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_col_mapping(data: object) -> Union["RemoteExportResponseColMappingType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                col_mapping_type_0 = RemoteExportResponseColMappingType0.from_dict(data)

                return col_mapping_type_0
            except:  # noqa: E722
                pass
            return cast(Union["RemoteExportResponseColMappingType0", None, Unset], data)
        ...
        remote_export_response.additional_properties = d
        return remote_export_response
