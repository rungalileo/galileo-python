...
T = TypeVar("T", bound="RetrieverSpanRecordMetricInfoType0")


@_attrs_define
class RetrieverSpanRecordMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retriever_span_record_metric_info_type_0.additional_properties = additional_properties
        return retriever_span_record_metric_info_type_0
