...
T = TypeVar("T", bound="RetrieverSpanRecordWithChildrenMetricInfoType0")


@_attrs_define
class RetrieverSpanRecordWithChildrenMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        retriever_span_record_with_children_metric_info_type_0 = cls()
        ...
        retriever_span_record_with_children_metric_info_type_0.additional_properties = additional_properties
        return retriever_span_record_with_children_metric_info_type_0
