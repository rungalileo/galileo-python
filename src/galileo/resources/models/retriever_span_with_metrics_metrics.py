...
T = TypeVar("T", bound="RetrieverSpanWithMetricsMetrics")


@_attrs_define
class RetrieverSpanWithMetricsMetrics:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        retriever_span_with_metrics_metrics = cls()
        ...
        retriever_span_with_metrics_metrics.additional_properties = additional_properties
        return retriever_span_with_metrics_metrics
