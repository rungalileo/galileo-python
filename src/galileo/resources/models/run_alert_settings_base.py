...
T = TypeVar("T", bound="RunAlertSettingsBase")


@_attrs_define
class RunAlertSettingsBase:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        run_alert_settings_base = cls(emails=emails, webhooks=webhooks)

        run_alert_settings_base.additional_properties = d
        return run_alert_settings_base
