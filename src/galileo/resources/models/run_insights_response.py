...
T = TypeVar("T", bound="RunInsightsResponse")


@_attrs_define
class RunInsightsResponse:
    """
    Attributes:
        run_id (str): The ID of the run this settings belong to.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        run_insights_response = cls(run_id=run_id, insights=insights)

        run_insights_response.additional_properties = d
        return run_insights_response
