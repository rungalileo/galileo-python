...
from ..models.scorer_created_at_filter_operator import (
    ScorerCreatedAtFilterOperator,
    check_scorer_created_at_filter_operator,
)
...
class ScorerCreatedAtFilter:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        operator = check_scorer_created_at_filter_operator(d.pop("operator"))
