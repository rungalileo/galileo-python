...
class ScorersConfig:
    ...
    Attributes:
        ...
        registered_scorers (list[RegisteredScorer] | Unset): List of user registered scorers to enable.
        generated_scorers (list[GeneratedScorer] | Unset): List of user generated scorers to enable.
        finetuned_scorers (list[FineTunedScorer] | Unset): List of user fine-tuned scorers to enable.
    """
    ...
    registered_scorers: list[RegisteredScorer] | Unset = UNSET
    generated_scorers: list[GeneratedScorer] | Unset = UNSET
    finetuned_scorers: list[FineTunedScorer] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _finetuned_scorers is not UNSET:
            ...
            for finetuned_scorers_item_data in _finetuned_scorers:
                finetuned_scorers_item = FineTunedScorer.from_dict(finetuned_scorers_item_data)
