...
class SessionRecord:
    ...
    Attributes:
        ...
        metric_info (Union['SessionRecordMetricInfoType0', None, Unset]): Detailed information about the metrics
        ...
        user_metadata (Union[Unset, SessionRecordUserMetadata]): Metadata associated with this trace or span.
    """
    ...
    metric_info: Union["SessionRecordMetricInfoType0", None, Unset] = UNSET
    ...
    user_metadata: Union[Unset, "SessionRecordUserMetadata"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metric_info, Unset):
            metric_info = UNSET
        elif isinstance(self.metric_info, SessionRecordMetricInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_metadata: Union[Unset, SessionRecordDatasetMetadata]
        if isinstance(_dataset_metadata, Unset):
            dataset_metadata = UNSET
        else:
            dataset_metadata = SessionRecordDatasetMetadata.from_dict(_dataset_metadata)
        ...
        def _parse_metric_info(data: object) -> Union["SessionRecordMetricInfoType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metric_info_type_0 = SessionRecordMetricInfoType0.from_dict(data)

                return metric_info_type_0
            except:  # noqa: E722
                pass
            return cast(Union["SessionRecordMetricInfoType0", None, Unset], data)
        ...
        user_metadata: Union[Unset, SessionRecordUserMetadata]
        if isinstance(_user_metadata, Unset):
            user_metadata = UNSET
        else:
            user_metadata = SessionRecordUserMetadata.from_dict(_user_metadata)
        ...
        session_record.additional_properties = d
