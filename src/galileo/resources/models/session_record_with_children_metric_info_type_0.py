...
T = TypeVar("T", bound="SessionRecordWithChildrenMetricInfoType0")


@_attrs_define
class SessionRecordWithChildrenMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        session_record_with_children_metric_info_type_0 = cls()
        ...
        session_record_with_children_metric_info_type_0.additional_properties = additional_properties
        return session_record_with_children_metric_info_type_0
