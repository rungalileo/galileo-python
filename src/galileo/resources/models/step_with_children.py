...
if TYPE_CHECKING:
    ...
    from ..models.step_with_children_input_type_3 import StepWithChildrenInputType3
    from ..models.step_with_children_input_type_7_item import StepWithChildrenInputType7Item
    from ..models.step_with_children_input_type_8_item import StepWithChildrenInputType8Item
    from ..models.step_with_children_metadata import StepWithChildrenMetadata
    from ..models.step_with_children_output_type_3 import StepWithChildrenOutputType3
    from ..models.step_with_children_output_type_7_item import StepWithChildrenOutputType7Item
    from ..models.step_with_children_output_type_8_item import StepWithChildrenOutputType8Item
    from ..models.step_with_children_redacted_input_type_3 import StepWithChildrenRedactedInputType3
    from ..models.step_with_children_redacted_input_type_7_item import StepWithChildrenRedactedInputType7Item
    from ..models.step_with_children_redacted_input_type_8_item import StepWithChildrenRedactedInputType8Item
    from ..models.step_with_children_redacted_output_type_3 import StepWithChildrenRedactedOutputType3
    from ..models.step_with_children_redacted_output_type_7_item import StepWithChildrenRedactedOutputType7Item
    from ..models.step_with_children_redacted_output_type_8_item import StepWithChildrenRedactedOutputType8Item
    from ..models.tool_step import ToolStep
    from ..models.workflow_step import WorkflowStep


T = TypeVar("T", bound="StepWithChildren")
...
class StepWithChildren:
    """
    Attributes:
        input_ (Document | list[Document] | list[MessagesListItem] | list[StepWithChildrenInputType7Item] |
            list[StepWithChildrenInputType8Item] | list[str] | MessagesListItem | StepWithChildrenInputType3 | str): Input
            to the step.
        type_ (NodeType | Unset):
        redacted_input (Document | list[Document] | list[MessagesListItem] |
            list[StepWithChildrenRedactedInputType7Item] | list[StepWithChildrenRedactedInputType8Item] | list[str] |
            MessagesListItem | None | StepWithChildrenRedactedInputType3 | str | Unset): Redacted input of the step. This is
            used to redact sensitive information.
        output (Document | list[Document] | list[MessagesListItem] | list[StepWithChildrenOutputType7Item] |
            list[StepWithChildrenOutputType8Item] | list[str] | MessagesListItem | StepWithChildrenOutputType3 | str |
            Unset): Output of the step. Default: ''.
        redacted_output (Document | list[Document] | list[MessagesListItem] |
            list[StepWithChildrenRedactedOutputType7Item] | list[StepWithChildrenRedactedOutputType8Item] | list[str] |
            MessagesListItem | None | StepWithChildrenRedactedOutputType3 | str | Unset): Redacted output of the step. This
            is used to redact sensitive information.
        ...
        metadata (StepWithChildrenMetadata | Unset): Metadata associated with this step.
    ...
    input_: (
        ...
        | list[StepWithChildrenInputType7Item]
        | list[StepWithChildrenInputType8Item]
        | list[str]
        | MessagesListItem
    ...
    redacted_input: (
        ...
        | list[Document]
        | list[MessagesListItem]
        | list[StepWithChildrenRedactedInputType7Item]
        | list[StepWithChildrenRedactedInputType8Item]
        | list[str]
        | MessagesListItem
        | None
    ...
    output: (
        ...
        | list[Document]
        | list[MessagesListItem]
        | list[StepWithChildrenOutputType7Item]
        | list[StepWithChildrenOutputType8Item]
        | list[str]
        | MessagesListItem
    ...
    redacted_output: (
        ...
        | list[Document]
        | list[MessagesListItem]
        | list[StepWithChildrenRedactedOutputType7Item]
        | list[StepWithChildrenRedactedOutputType8Item]
        | list[str]
        | MessagesListItem
        | None
    ...
    metadata: StepWithChildrenMetadata | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.input_, Document):
            ...
            input_ = self.input_.to_dict()
        elif isinstance(self.input_, StepWithChildrenInputType3):
            input_ = self.input_.to_dict()
        ...
        if isinstance(self.redacted_input, Unset):
            ...
            redacted_input = self.redacted_input.to_dict()
        elif isinstance(self.redacted_input, StepWithChildrenRedactedInputType3):
            redacted_input = self.redacted_input.to_dict()
        ...
        if isinstance(self.output, Unset):
            ...
            output = self.output.to_dict()
        elif isinstance(self.output, StepWithChildrenOutputType3):
            output = self.output.to_dict()
        ...
        if isinstance(self.redacted_output, Unset):
            ...
            redacted_output = self.redacted_output.to_dict()
        elif isinstance(self.redacted_output, StepWithChildrenRedactedOutputType3):
            redacted_output = self.redacted_output.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_input_(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                input_type_3 = StepWithChildrenInputType3.from_dict(data)
            ...
            try:
                ...
                for input_type_7_item_data in _input_type_7:
                    input_type_7_item = StepWithChildrenInputType7Item.from_dict(input_type_7_item_data)
            ...
            try:
                ...
                for input_type_8_item_data in _input_type_8:
                    input_type_8_item = StepWithChildrenInputType8Item.from_dict(input_type_8_item_data)
        ...
        def _parse_redacted_input(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                redacted_input_type_3 = StepWithChildrenRedactedInputType3.from_dict(data)
            ...
            try:
                ...
                for redacted_input_type_7_item_data in _redacted_input_type_7:
                    redacted_input_type_7_item = StepWithChildrenRedactedInputType7Item.from_dict(
            ...
            try:
                ...
                for redacted_input_type_8_item_data in _redacted_input_type_8:
                    redacted_input_type_8_item = StepWithChildrenRedactedInputType8Item.from_dict(
        ...
        def _parse_output(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                output_type_3 = StepWithChildrenOutputType3.from_dict(data)
            ...
            try:
                ...
                for output_type_7_item_data in _output_type_7:
                    output_type_7_item = StepWithChildrenOutputType7Item.from_dict(output_type_7_item_data)
            ...
            try:
                ...
                for output_type_8_item_data in _output_type_8:
                    output_type_8_item = StepWithChildrenOutputType8Item.from_dict(output_type_8_item_data)
        ...
        def _parse_redacted_output(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                redacted_output_type_3 = StepWithChildrenRedactedOutputType3.from_dict(data)
            ...
            try:
                ...
                for redacted_output_type_7_item_data in _redacted_output_type_7:
                    redacted_output_type_7_item = StepWithChildrenRedactedOutputType7Item.from_dict(
            ...
            try:
                ...
                for redacted_output_type_8_item_data in _redacted_output_type_8:
                    redacted_output_type_8_item = StepWithChildrenRedactedOutputType8Item.from_dict(
        ...
        metadata: StepWithChildrenMetadata | Unset
        if isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = StepWithChildrenMetadata.from_dict(_metadata)
        ...
        step_with_children.additional_properties = d
        return step_with_children
