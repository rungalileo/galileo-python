...
class StepWithChildren:
    """
    Attributes:
        input_ (Union['Document', 'Message', 'StepWithChildrenInputType3', list['Document'], list['Message'],
            list['StepWithChildrenInputType7Item'], list['StepWithChildrenInputType8Item'], list[str], str]): Input to the
            step.
        ...
        metadata (Union[Unset, StepWithChildrenMetadata]): Metadata associated with this step.
        name (Union[Unset, str]): Name of the step. Default: ''.
        output (Union['Document', 'Message', 'StepWithChildrenOutputType3', Unset, list['Document'], list['Message'],
            list['StepWithChildrenOutputType7Item'], list['StepWithChildrenOutputType8Item'], list[str], str]): Output of
            the step. Default: ''.
    ...
    metadata: Union[Unset, "StepWithChildrenMetadata"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, StepWithChildrenMetadata]
