...
class ToolSpanRecord:
    ...
    Attributes:
        ...
        dataset_metadata (Union[Unset, ToolSpanRecordDatasetMetadata]): Metadata from the dataset associated with this
            trace
        ...
        user_metadata (Union[Unset, ToolSpanRecordUserMetadata]): Metadata associated with this trace or span.
    """
    ...
    dataset_metadata: Union[Unset, "ToolSpanRecordDatasetMetadata"] = UNSET
    ...
    user_metadata: Union[Unset, "ToolSpanRecordUserMetadata"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metric_info, Unset):
            metric_info = UNSET
        elif isinstance(self.metric_info, ToolSpanRecordMetricInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_metadata: Union[Unset, ToolSpanRecordDatasetMetadata]
        if isinstance(_dataset_metadata, Unset):
            dataset_metadata = UNSET
        else:
            dataset_metadata = ToolSpanRecordDatasetMetadata.from_dict(_dataset_metadata)
        ...
        def _parse_metric_info(data: object) -> Union["ToolSpanRecordMetricInfoType0", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metric_info_type_0 = ToolSpanRecordMetricInfoType0.from_dict(data)

                return metric_info_type_0
            except:  # noqa: E722
                pass
            return cast(Union["ToolSpanRecordMetricInfoType0", None, Unset], data)
        ...
        user_metadata: Union[Unset, ToolSpanRecordUserMetadata]
        if isinstance(_user_metadata, Unset):
            user_metadata = UNSET
        else:
            user_metadata = ToolSpanRecordUserMetadata.from_dict(_user_metadata)

        tool_span_record = cls(
            id=id,
            input_=input_,
            parent_id=parent_id,
            project_id=project_id,
        ...
        tool_span_record.additional_properties = d
        return tool_span_record
