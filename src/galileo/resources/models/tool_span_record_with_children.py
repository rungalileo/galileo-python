...
class ToolSpanRecordWithChildren:
    ...
    Attributes:
        ...
        dataset_metadata (Union[Unset, ToolSpanRecordWithChildrenDatasetMetadata]): Metadata from the dataset associated
            with this trace
        ...
        metric_info (Union['ToolSpanRecordWithChildrenMetricInfoType0', None, Unset]): Detailed information about the
        ...
        user_metadata (Union[Unset, ToolSpanRecordWithChildrenUserMetadata]): Metadata associated with this trace or
            span.
    """
    ...
    dataset_metadata: Union[Unset, "ToolSpanRecordWithChildrenDatasetMetadata"] = UNSET
    ...
    metric_info: Union["ToolSpanRecordWithChildrenMetricInfoType0", None, Unset] = UNSET
    ...
    user_metadata: Union[Unset, "ToolSpanRecordWithChildrenUserMetadata"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metric_info, Unset):
            metric_info = UNSET
        elif isinstance(self.metric_info, ToolSpanRecordWithChildrenMetricInfoType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_metadata: Union[Unset, ToolSpanRecordWithChildrenDatasetMetadata]
        ...
        def _parse_metric_info(data: object) -> Union["ToolSpanRecordWithChildrenMetricInfoType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metric_info_type_0 = ToolSpanRecordWithChildrenMetricInfoType0.from_dict(data)

                return metric_info_type_0
            except:  # noqa: E722
                pass
            return cast(Union["ToolSpanRecordWithChildrenMetricInfoType0", None, Unset], data)
        ...
        user_metadata: Union[Unset, ToolSpanRecordWithChildrenUserMetadata]
