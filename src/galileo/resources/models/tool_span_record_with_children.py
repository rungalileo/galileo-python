...
if TYPE_CHECKING:
    ...
    from ..models.control_span_record import ControlSpanRecord
    ...
    from ..models.tool_span_record_with_children_annotation_aggregates import (
        ToolSpanRecordWithChildrenAnnotationAggregates,
    )
    from ..models.tool_span_record_with_children_annotations import ToolSpanRecordWithChildrenAnnotations
    from ..models.tool_span_record_with_children_dataset_metadata import ToolSpanRecordWithChildrenDatasetMetadata
    from ..models.tool_span_record_with_children_feedback_rating_info import (
...
@_attrs_define
class ToolSpanRecordWithChildren:
    """
    Attributes:
        ...
        spans (list[AgentSpanRecordWithChildren | ControlSpanRecord | LlmSpanRecord | RetrieverSpanRecordWithChildren |
            ToolSpanRecordWithChildren | WorkflowSpanRecordWithChildren] | Unset):
        ...
        user_metadata (ToolSpanRecordWithChildrenUserMetadata | Unset): Metadata associated with this trace or span.
        ...
        dataset_metadata (ToolSpanRecordWithChildrenDatasetMetadata | Unset): Metadata from the dataset associated with
            this trace
        ...
        feedback_rating_info (ToolSpanRecordWithChildrenFeedbackRatingInfo | Unset): Feedback information related to the
            record
        annotations (ToolSpanRecordWithChildrenAnnotations | Unset): Annotations keyed by template ID and annotator ID
        ...
        annotation_aggregates (ToolSpanRecordWithChildrenAnnotationAggregates | Unset): Annotation aggregate information
    ...
    user_metadata: ToolSpanRecordWithChildrenUserMetadata | Unset = UNSET
    ...
    dataset_metadata: ToolSpanRecordWithChildrenDatasetMetadata | Unset = UNSET
    ...
    feedback_rating_info: ToolSpanRecordWithChildrenFeedbackRatingInfo | Unset = UNSET
    annotations: ToolSpanRecordWithChildrenAnnotations | Unset = UNSET
    file_ids: list[str] | Unset = UNSET
    file_modalities: list[ContentModality] | Unset = UNSET
    annotation_aggregates: ToolSpanRecordWithChildrenAnnotationAggregates | Unset = UNSET
        ...
        if not isinstance(self.spans, Unset):
            ...
            for spans_item_data in self.spans:
                ...
                if isinstance(spans_item_data, AgentSpanRecordWithChildren):
                    ...
                    spans_item = spans_item_data.to_dict()
                elif isinstance(spans_item_data, RetrieverSpanRecordWithChildren):
                    spans_item = spans_item_data.to_dict()
                else:
                    spans_item = spans_item_data.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _spans is not UNSET:
            ...
            for spans_item_data in _spans:
                ...
                def _parse_spans_item(
                    ...
                    if not isinstance(data, dict):
                        raise TypeError()
                    spans_item_type_5 = ControlSpanRecord.from_dict(data)
        ...
        user_metadata: ToolSpanRecordWithChildrenUserMetadata | Unset
        if isinstance(_user_metadata, Unset):
            user_metadata = UNSET
        else:
            user_metadata = ToolSpanRecordWithChildrenUserMetadata.from_dict(_user_metadata)
        ...
        dataset_metadata: ToolSpanRecordWithChildrenDatasetMetadata | Unset
        if isinstance(_dataset_metadata, Unset):
            dataset_metadata = UNSET
        else:
            dataset_metadata = ToolSpanRecordWithChildrenDatasetMetadata.from_dict(_dataset_metadata)
        ...
        feedback_rating_info: ToolSpanRecordWithChildrenFeedbackRatingInfo | Unset
        if isinstance(_feedback_rating_info, Unset):
            feedback_rating_info = UNSET
        else:
            feedback_rating_info = ToolSpanRecordWithChildrenFeedbackRatingInfo.from_dict(_feedback_rating_info)

        _annotations = d.pop("annotations", UNSET)
        annotations: ToolSpanRecordWithChildrenAnnotations | Unset
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = ToolSpanRecordWithChildrenAnnotations.from_dict(_annotations)
        ...
        annotation_aggregates: ToolSpanRecordWithChildrenAnnotationAggregates | Unset
        if isinstance(_annotation_aggregates, Unset):
            annotation_aggregates = UNSET
        else:
            annotation_aggregates = ToolSpanRecordWithChildrenAnnotationAggregates.from_dict(_annotation_aggregates)
        ...
        tool_span_record_with_children = cls(
            id=id,
        ...
        tool_span_record_with_children.additional_properties = d
        return tool_span_record_with_children
