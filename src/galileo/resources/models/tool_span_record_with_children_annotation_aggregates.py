...
T = TypeVar("T", bound="ToolSpanRecordWithChildrenAnnotationAggregates")


@_attrs_define
class ToolSpanRecordWithChildrenAnnotationAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        tool_span_record_with_children_annotation_aggregates = cls()
        ...
        tool_span_record_with_children_annotation_aggregates.additional_properties = additional_properties
        return tool_span_record_with_children_annotation_aggregates
