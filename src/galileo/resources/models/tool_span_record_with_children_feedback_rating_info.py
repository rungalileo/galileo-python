...
T = TypeVar("T", bound="ToolSpanRecordWithChildrenFeedbackRatingInfo")


@_attrs_define
class ToolSpanRecordWithChildrenFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        tool_span_record_with_children_feedback_rating_info = cls()
        ...
        tool_span_record_with_children_feedback_rating_info.additional_properties = additional_properties
        return tool_span_record_with_children_feedback_rating_info
