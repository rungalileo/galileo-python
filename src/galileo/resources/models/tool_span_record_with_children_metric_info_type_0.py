...
T = TypeVar("T", bound="ToolSpanRecordWithChildrenMetricInfoType0")


@_attrs_define
class ToolSpanRecordWithChildrenMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        tool_span_record_with_children_metric_info_type_0 = cls()
        ...
        tool_span_record_with_children_metric_info_type_0.additional_properties = additional_properties
        return tool_span_record_with_children_metric_info_type_0
