...
T = TypeVar("T", bound="TraceRecordFeedbackRatingInfo")


@_attrs_define
class TraceRecordFeedbackRatingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        trace_record_feedback_rating_info = cls()
        ...
        trace_record_feedback_rating_info.additional_properties = additional_properties
        return trace_record_feedback_rating_info
