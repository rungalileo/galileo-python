...
if TYPE_CHECKING:
    ...
    from ..models.trace_record_with_children_annotation_aggregates import TraceRecordWithChildrenAnnotationAggregates
    from ..models.trace_record_with_children_annotations import TraceRecordWithChildrenAnnotations
...
class TraceRecordWithChildren:
    ...
    Attributes:
        ...
        user_metadata (TraceRecordWithChildrenUserMetadata | Unset): Metadata associated with this trace or span.
        ...
        dataset_metadata (TraceRecordWithChildrenDatasetMetadata | Unset): Metadata from the dataset associated with
            this trace
        ...
        feedback_rating_info (TraceRecordWithChildrenFeedbackRatingInfo | Unset): Feedback information related to the
            record
        annotations (TraceRecordWithChildrenAnnotations | Unset): Annotations keyed by template ID and annotator ID
        ...
        annotation_aggregates (TraceRecordWithChildrenAnnotationAggregates | Unset): Annotation aggregate information
    ...
    user_metadata: TraceRecordWithChildrenUserMetadata | Unset = UNSET
    ...
    dataset_metadata: TraceRecordWithChildrenDatasetMetadata | Unset = UNSET
    updated_at: datetime.datetime | None | Unset = UNSET
    has_children: bool | None | Unset = UNSET
    metrics_batch_id: None | str | Unset = UNSET
    session_batch_id: None | str | Unset = UNSET
    feedback_rating_info: TraceRecordWithChildrenFeedbackRatingInfo | Unset = UNSET
    annotations: TraceRecordWithChildrenAnnotations | Unset = UNSET
    file_ids: list[str] | Unset = UNSET
    file_modalities: list[ContentModality] | Unset = UNSET
    annotation_aggregates: TraceRecordWithChildrenAnnotationAggregates | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.text_content_part import TextContentPart
        from ..models.tool_span_record_with_children import ToolSpanRecordWithChildren
        from ..models.trace_record_with_children_annotation_aggregates import (
        ...
        user_metadata: TraceRecordWithChildrenUserMetadata | Unset
        if isinstance(_user_metadata, Unset):
            user_metadata = UNSET
        else:
            user_metadata = TraceRecordWithChildrenUserMetadata.from_dict(_user_metadata)
        ...
        dataset_metadata: TraceRecordWithChildrenDatasetMetadata | Unset
        ...
        feedback_rating_info: TraceRecordWithChildrenFeedbackRatingInfo | Unset
        ...
        annotations: TraceRecordWithChildrenAnnotations | Unset
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = TraceRecordWithChildrenAnnotations.from_dict(_annotations)
        ...
        annotation_aggregates: TraceRecordWithChildrenAnnotationAggregates | Unset
        if isinstance(_annotation_aggregates, Unset):
            annotation_aggregates = UNSET
        else:
            annotation_aggregates = TraceRecordWithChildrenAnnotationAggregates.from_dict(_annotation_aggregates)

        annotation_queue_ids = cast(list[str], d.pop("annotation_queue_ids", UNSET))

        is_complete = d.pop("is_complete", UNSET)

        trace_record_with_children = cls(
            id=id,
        ...
        trace_record_with_children.additional_properties = d
        return trace_record_with_children
