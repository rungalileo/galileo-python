...
T = TypeVar("T", bound="TraceRecordWithChildrenAnnotationAggregates")


@_attrs_define
class TraceRecordWithChildrenAnnotationAggregates:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        trace_record_with_children_annotation_aggregates = cls()
        ...
        trace_record_with_children_annotation_aggregates.additional_properties = additional_properties
        return trace_record_with_children_annotation_aggregates
