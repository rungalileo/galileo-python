...
T = TypeVar("T", bound="TraceRecordWithChildrenMetricInfoType0")


@_attrs_define
class TraceRecordWithChildrenMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        trace_record_with_children_metric_info_type_0 = cls()
        ...
        trace_record_with_children_metric_info_type_0.additional_properties = additional_properties
        return trace_record_with_children_metric_info_type_0
