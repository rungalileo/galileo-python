...
class TransactionRecordIngest:
    ...
    Attributes:
        ...
        chain_root_id (None | str | Unset):
        output_logprobs (None | TransactionRecordIngestOutputLogprobsType0 | Unset):
        temperature (float | None | Unset):
        tags (list[str] | None | Unset):
        user_metadata (None | TransactionRecordIngestUserMetadataType0 | Unset):
        node_name (None | str | Unset):
        has_children (bool | None | Unset):
        version (None | str | Unset):
        redacted_input (None | str | Unset):
        output_text (None | str | Unset):
    ...
    chain_root_id: None | str | Unset = UNSET
    output_logprobs: None | TransactionRecordIngestOutputLogprobsType0 | Unset = UNSET
    temperature: float | None | Unset = UNSET
    tags: list[str] | None | Unset = UNSET
    user_metadata: None | TransactionRecordIngestUserMetadataType0 | Unset = UNSET
    node_name: None | str | Unset = UNSET
    has_children: bool | None | Unset = UNSET
    version: None | str | Unset = UNSET
    redacted_input: None | str | Unset = UNSET
    output_text: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        output_logprobs: dict[str, Any] | None | Unset
        ...
        field_dict.update(
            {"node_id": node_id, "created_at": created_at, "node_type": node_type, "input_text": input_text}
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_chain_root_id(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_output_logprobs(data: object) -> None | TransactionRecordIngestOutputLogprobsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | TransactionRecordIngestOutputLogprobsType0 | Unset, data)
        ...
        def _parse_user_metadata(data: object) -> None | TransactionRecordIngestUserMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | TransactionRecordIngestUserMetadataType0 | Unset, data)
        ...
        def _parse_output_text(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
