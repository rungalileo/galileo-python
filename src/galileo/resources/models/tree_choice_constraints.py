...
class TreeChoiceConstraints:
    ...
    annotation_type: Literal["tree_choice"]
    choices_tree: None | Unset | list["TreeChoiceNode"] = UNSET
    choices_tree_yaml: None | Unset | str = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        annotation_type = self.annotation_type

        choices_tree: None | Unset | list[dict[str, Any]]
        ...
        choices_tree_yaml: None | Unset | str
        choices_tree_yaml = UNSET if isinstance(self.choices_tree_yaml, Unset) else self.choices_tree_yaml
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_choices_tree(data: object) -> None | Unset | list["TreeChoiceNode"]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(None | Unset | list["TreeChoiceNode"], data)

        choices_tree = _parse_choices_tree(d.pop("choices_tree", UNSET))

        def _parse_choices_tree_yaml(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
