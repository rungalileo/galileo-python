...
class UserAnnotationQueueCollaborator:
    ...
    track_progress: Unset | bool = True
    progress: None | Unset | float = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        progress = UNSET if isinstance(self.progress, Unset) else self.progress
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_progress(data: object) -> None | Unset | float:
            if data is None:
                return data
