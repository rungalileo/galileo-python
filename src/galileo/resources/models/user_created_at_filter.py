...
from ..models.user_created_at_filter_operator import UserCreatedAtFilterOperator
from ..types import UNSET, Unset

T = TypeVar("T", bound="UserCreatedAtFilter")
...
class UserCreatedAtFilter:
    """
    Attributes:
        operator (UserCreatedAtFilterOperator):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        operator = UserCreatedAtFilterOperator(d.pop("operator"))
        ...
        user_created_at_filter = cls(operator=operator, value=value, name=name)

        user_created_at_filter.additional_properties = d
        return user_created_at_filter
