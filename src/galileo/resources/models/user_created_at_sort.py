...
T = TypeVar("T", bound="UserCreatedAtSort")


@_attrs_define
class UserCreatedAtSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_created_at_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        user_created_at_sort.additional_properties = d
        return user_created_at_sort
