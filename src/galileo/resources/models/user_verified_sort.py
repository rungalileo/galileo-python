...
T = TypeVar("T", bound="UserVerifiedSort")


@_attrs_define
class UserVerifiedSort:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_verified_sort = cls(name=name, ascending=ascending, sort_type=sort_type)

        user_verified_sort.additional_properties = d
        return user_verified_sort
