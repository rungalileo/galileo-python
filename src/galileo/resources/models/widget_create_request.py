...
if TYPE_CHECKING:
    from ..models.widget_create_request_dataset_type_0_item import WidgetCreateRequestDatasetType0Item


T = TypeVar("T", bound="WidgetCreateRequest")
...
class WidgetCreateRequest:
    ...
    Attributes:
        ...
        dataset (list[WidgetCreateRequestDatasetType0Item] | None | Unset):
    ...
    dataset: list[WidgetCreateRequestDatasetType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({"name": name, "type": type_, "metric": metric, "aggregation": aggregation})
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_dataset(data: object) -> list[WidgetCreateRequestDatasetType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for dataset_type_0_item_data in _dataset_type_0:
                    dataset_type_0_item = WidgetCreateRequestDatasetType0Item.from_dict(dataset_type_0_item_data)
                ...
                pass
            return cast(list[WidgetCreateRequestDatasetType0Item] | None | Unset, data)
        ...
        widget_create_request.additional_properties = d
        return widget_create_request
