...
T = TypeVar("T", bound="WorkflowSpanRecordMetricInfoType0")


@_attrs_define
class WorkflowSpanRecordMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        workflow_span_record_metric_info_type_0 = cls()
        ...
        workflow_span_record_metric_info_type_0.additional_properties = additional_properties
        return workflow_span_record_metric_info_type_0
