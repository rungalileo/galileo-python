...
T = TypeVar("T", bound="WorkflowSpanRecordWithChildren")


@_attrs_define
class WorkflowSpanRecordWithChildren:
    """
    Attributes:
        ...
        dataset_metadata (Union[Unset, WorkflowSpanRecordWithChildrenDatasetMetadata]): Metadata from the dataset
        ...
        metric_info (Union['WorkflowSpanRecordWithChildrenMetricInfoType0', None, Unset]): Detailed information about
        ...
        user_metadata (Union[Unset, WorkflowSpanRecordWithChildrenUserMetadata]): Metadata associated with this trace or
            span.
    """
    ...
    dataset_metadata: Union[Unset, "WorkflowSpanRecordWithChildrenDatasetMetadata"] = UNSET
    ...
    metric_info: Union["WorkflowSpanRecordWithChildrenMetricInfoType0", None, Unset] = UNSET
    ...
    user_metadata: Union[Unset, "WorkflowSpanRecordWithChildrenUserMetadata"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metric_info, Unset):
            metric_info = UNSET
        elif isinstance(self.metric_info, WorkflowSpanRecordWithChildrenMetricInfoType0):
        ...
        if not isinstance(self.spans, Unset):
            ...
            for spans_item_data in self.spans:
                ...
                if isinstance(spans_item_data, AgentSpanRecordWithChildren):
                    ...
                    spans_item = spans_item_data.to_dict()
                elif isinstance(spans_item_data, ToolSpanRecord):
                    spans_item = spans_item_data.to_dict()
                else:
                    spans_item = spans_item_data.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dataset_metadata: Union[Unset, WorkflowSpanRecordWithChildrenDatasetMetadata]
        if isinstance(_dataset_metadata, Unset):
            dataset_metadata = UNSET
        else:
            dataset_metadata = WorkflowSpanRecordWithChildrenDatasetMetadata.from_dict(_dataset_metadata)
        ...
        def _parse_metric_info(data: object) -> Union["WorkflowSpanRecordWithChildrenMetricInfoType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metric_info_type_0 = WorkflowSpanRecordWithChildrenMetricInfoType0.from_dict(data)

                return metric_info_type_0
            except:  # noqa: E722
                pass
            return cast(Union["WorkflowSpanRecordWithChildrenMetricInfoType0", None, Unset], data)
        ...
        user_metadata: Union[Unset, WorkflowSpanRecordWithChildrenUserMetadata]
        if isinstance(_user_metadata, Unset):
            user_metadata = UNSET
        else:
            user_metadata = WorkflowSpanRecordWithChildrenUserMetadata.from_dict(_user_metadata)

        workflow_span_record_with_children = cls(
            id=id,
            input_=input_,
            parent_id=parent_id,
            project_id=project_id,
        ...
        workflow_span_record_with_children.additional_properties = d
        return workflow_span_record_with_children
