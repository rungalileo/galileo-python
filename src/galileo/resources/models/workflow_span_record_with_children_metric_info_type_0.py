...
@_attrs_define
class WorkflowSpanRecordWithChildrenMetricInfoType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workflow_span_record_with_children_metric_info_type_0.additional_properties = additional_properties
        return workflow_span_record_with_children_metric_info_type_0
